...
;                               |*1      14 |                                    
;                               | 2      13 |                                    
;                               | 3      12 |  -> P1.4 MCLK ~62.5kHz             
;                               | 4      11 |                                    
;                               | 5      10 |                                    
;     P1.0 ACLK ~125kHz  <-     | 6       9 |                                    
;     P1.1 SMCLK ~32kHz  <-     | 7       8 |                                    
;                               +-----------+                                    
;                                                                                
...
check       mov.w    #0,&CCSCTL7            ; Clear HF & LF OSC fault flags
            ...
            mov.w    #DIVA_3 + DIVM_4 + DIVS_5,&CCSCTL5 ; Set the Dividers for ACLK to 8, MCLK to 16, and SMCLK to 32
