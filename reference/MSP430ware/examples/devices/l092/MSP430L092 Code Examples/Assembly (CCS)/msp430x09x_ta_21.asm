...
check       mov.w   #0,&CCSCTL7             ; Clear HF & LF OSC fault flags
            ...
            mov.w   #SELA_2+SELS_0+SELM_0,& CCSCTL4 ;Select CLKIN as the ACLK source and HFCLK/DCO as the source for SMCLK,MCLK
            mov.w   #DIVA_0+DIVS_0+DIVM_0,&CCSCTL5 ; Set the CLK Dividers to 1
