//******************************************************************************
//  MSP430x26x Demo - Flash In-System Programming w/ EEI, Copy SegC to SegD
//
//  Description: This program first erases flash seg C, then it increments all
//  values in seg C, then it erases seg D, then copies seg C to seg D.
//  The EEI bit (Interrupts during segment erase enabled) is set for the Flash 
//  Erase Cycles. This does allow the Timer_AInterrupts to be handled also 
//  during the Segment erase time. Starting  addresses of segments defined in
//  this code: Seg C-0x1040, Seg D-0x1000.
