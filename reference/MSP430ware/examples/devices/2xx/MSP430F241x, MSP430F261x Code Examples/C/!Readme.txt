...
MSP430x261x_dma_02_CCE.c          (Built with CCE) DMA0, Repeated single transfer to P1OUT, TACCR2 Trigger
...
MSP430x261x_dma_05_CCE.c          (Built with CCE) DMA0, Repeated single transfer to DAC0, Sine Output, TACCR1, DCO
MSP430x261x_dma_05_IAR.c          (Built with IAR) DMA0, Repeated single transfer to DAC0, Sine Output, TACCR1, DCO
...
MSP430x261x_dma_07_IAR.c          (Built with IAR) DMA0/1, Rpt'd single transfer to DAC12_0/1, Sin/Cos, TACCR1, XT2
MSP430x261x_dma_09_CCE.c          (Built with CCE) DMA0, ADC12 A10 single Block Xfer to RAM, TBCCR1, DCO
MSP430x261x_dma_09_IAR.c          (Built with IAR) DMA0, ADC12 A10 single blocktransfer Xfer to RAM, TBCCR1, DCO
