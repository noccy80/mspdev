//******************************************************************************
//  MSP430x24x Demo - Configure RST/NMI as NMI
//
//  Description: Configure RST/NMI as NMI, hi to low edge. Flash P1.0 inside of
//  NMI_ISR (5 times) if NMI occurs. General enable interrupt in status register 
//  does not need to be set for NMI. NMIIE does need to be re-set, as NMI_ISR
