;*******************************************************************************
;   MSP430F21x2 Demo - USCI_B0 I2C Master Interface to PCF8574, Read/Write
;
...
SetupTA     mov.w   #CCIE,&TA0CCTL0          ; TACCR0 interrupt enabled
...
;-------------------------------------------------------------------------------
            ...
            .short	TA0_ISR
            .sect	".int06"				;USCI_B0 I2C Data Int Vector
            .short	USCIAB0TX_ISR
