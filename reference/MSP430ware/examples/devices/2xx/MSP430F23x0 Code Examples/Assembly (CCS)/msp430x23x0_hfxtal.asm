;*******************************************************************************
;   MSP430F23x0 Demo - Basic Clock, MCLK Sourced from HF XTAL
;
...
;   sourced by LFXT1. MCLK/10 is on P1.2 driven by a software loop taking
...
SetupOsc1   dec.w   R15                     ; Additional delay to ensure start
            ...
            bis.b   #004h,&P1DIR            ; P1.2 = output direction
                                            ;
