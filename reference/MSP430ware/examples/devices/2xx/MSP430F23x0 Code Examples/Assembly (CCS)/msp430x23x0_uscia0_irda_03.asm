;*******************************************************************************
;   MSP430F23x0 Demo - USCI_A0 IrDA Physical Layer Comm, 8MHz SMCLK
;
...
;      #    LED|-----+ 9600 8N1 |               P1.2/TA1|<-- Terminal SW
;      #    TxD|<---------------|P3.4/UCA0TXD           |
;      #    RxD|--------------->|P3.5/UCA0RXD           |
;      #     SD|-----+          |                       |
;      |    GND|-----+          |                       |
...
;-------------------------------------------------------------------------------
TXData      .usect	".bss",2                       ; Timer_A UART TX data
TxBitCnt    .usect	".bss",1                       ; Timer_A UART TX bit counter
RXData      .usect	".bss",1                       ; Timer_A UART RX data
RxBitCnt    .usect	".bss",1                       ; Timer_A UART RX bit counter
Flags       .usect	".bss",1                       ; Flag register
RXDataIR    .usect	".bss",1                       ; Received IrDA data
;-------------------------------------------------------------------------------
...
SetupP1     bis.b   #00ch,&P1SEL            ; Use P1.2/P1.3 for Timer_A
...
;-------------------------------------------------------------------------------
            ...
            mov.w   #SCS+CM1+CAP+CCIE,&TACCTL1
