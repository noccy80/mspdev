;******************************************************************************
;   MSP430x21x1 Demo - Timer_A, UART 115200 Echo, 12MHz DCO SMCLK
;
...
;   ACLK = n/a, MCLK = TACLK = DCO = 12000000Hz
;
;               MSP430F21x1
;            -----------------
;        /|\|              XIN|-
...
;   Conditions for 115200 Baud SW UART, SMCLK = 12MHz
Bitime_5    .equ    52                      ; ~ 0.5 bit length
Bitime      .equ    104                     ; 115384 baud
;------------------------------------------------------------------------------
            .text                           ;
;------------------------------------------------------------------------------
RESET       mov.w   #300h,SP                ; Initialize stackpointer
StopWDT     mov.w   #WDTPW+WDTHOLD,&WDTCTL  ; Stop Watchdog Timer
            mov.b   &CALBC1_12MHZ,&BCSCTL1  ; Set DCO
