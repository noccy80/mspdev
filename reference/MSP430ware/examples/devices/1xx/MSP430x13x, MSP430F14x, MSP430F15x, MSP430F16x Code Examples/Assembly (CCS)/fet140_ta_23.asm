;******************************************************************************
;   MSP-FET430P140 Demo - Timer_A, PWM TA1-2, Up/Down Mode, XT2 HF XTAL SMCLK
;
;   Description: This program generates two PWM outputs on P1.2,3 using
;   Timer_A configured for up/down mode. The value in CCR0, 512, defines
;   PWM the period/2 and the values in CCR1 and CCR2 the PWM duty cycles.
...
SetupC0     mov.w   #512,&CCR0              ; PWM Period/2
SetupC1     mov.w   #OUTMOD_2,&CCTL1        ; CCR1 toggle/reset
            mov.w   #384,&CCR1              ; CCR1 PWM Duty Cycle	
SetupC2     mov.w   #OUTMOD_2,&CCTL2        ; CCR2 toggle/reset
            mov.w   #128,&CCR2              ; CCR2 PWM duty cycle	
SetupTA     mov.w   #TASSEL_2+MC_3,&TACTL   ; SMCLK, up/down mode
                                            ;					
