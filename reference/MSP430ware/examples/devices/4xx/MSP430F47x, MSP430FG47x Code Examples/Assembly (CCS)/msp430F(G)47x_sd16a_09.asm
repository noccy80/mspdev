;******************************************************************************
;      MSP430FG47x Demo - SD16_A, Single Conversion on a Single Channel Using ISR
;
...
;   conversion has completed. Test by applying a voltage to CH1
;   (A1+, A1-) and setting a breakpoint at the line indicated below.
...
Port6Con    bis.b   BIT3+BIT4,&P6SEL        ; Configure SD16 pins
...
SetupSD16   mov.w   #SD16REFON+SD16SSEL0,&SD16CTL ; 1.2V ref, SMCLK
            bis.w   #SD16SNGL+SD16IE+SD16BUF_3,&SD16CCTL0 ; Single conv, enable interrupt, high impedance
            bis.b   #SD16INTDLY_0+SD16INCH_1,&SD16INCTL0 ; 4th sample generates interrupt
...
SD_CH0      mov.w   &SD16MEM0,RESULTS       ; Save CH1 conversion result
