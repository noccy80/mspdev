;******************************************************************************
;      MSP430FG47x Demo - SD16_A, Single Conversion on Single Channel Using ISR
;                               1024 Extended Oversampling Rate
;
...
SetupSD16   mov.w   #SD16REFON+SD16SSEL0,&SD16CTL ; 1.2V ref, SMCLK
            bis.w   #SD16SNGL+SD16IE+SD16XOSR+SD16OSR0,&SD16CCTL0 ; Single conv, enable interrupt, 1024 OSR
