//*****************************************************************************
//   MSP430F(G)47x Demo - SD16_A, Single Conversion on a Single Channel Using ISR
//
...
void main(void)
{
  ...
  SD16INCTL0 |= SD16INTDLY_0+SD16INCH_1;    // Interrupt on 4th sample
...
__interrupt void SD16ISR(void)
{
  ...
  case 2:                                   // SD16MEM Overflow
    break;
  case 4:                                   // SD16MEM0 IFG
    result = SD16MEM0;                      // Save CH1 results (clears IFG)
    break;
  }
