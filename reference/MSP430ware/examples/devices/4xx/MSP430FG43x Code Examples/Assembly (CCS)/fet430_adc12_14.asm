;******************************************************************************
;   MSP-FET430P430 Demo - ADC12, Using the Internal Reference, Channel A15
;
...
;   on channel A15. The conversion results are stored in ADC12MEM0 and are
;   moved to R5 after the conversion is complete. Test by applying a voltage
;   to channel A15, then setting and running to a break point at "jmp Mainloop"
