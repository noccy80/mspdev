;******************************************************************************
;   MSP-FET430P430 Demo - ADC12, Using the Internal Reference, Channel A13
;
...
;   on channel A13. The conversion results are stored in ADC12MEM0 and are
;   moved to R5 after the conversion is complete. Test by applying a voltage
;   to channel A13, then setting and running to a break point at "jmp Mainloop"
