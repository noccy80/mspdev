...
//  channel A13. The conversion results are stored in ADC12MEM0. Test by
//  applying a voltage to channel A13, then setting and running to a break point
...
void main(void)
{
  ...
  P5SEL |= 0x01;                            // Enable A/D channel A0
  ADC12CTL0 = ADC12ON+SHT0_2;               // Turn on ADC12, set sampling time
  ADC12CTL1 = SHP;                          // Use sampling timer
  ADC12MCTL0 = INCH_13;                     // Input channel 13
