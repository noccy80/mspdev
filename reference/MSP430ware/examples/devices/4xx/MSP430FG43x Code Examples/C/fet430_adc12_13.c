//******************************************************************************
//  MSP-FET430P430 Demo - ADC12, Single Conversion on Channel A14
//
...
//  channel A14. The conversion results are stored in ADC12MEM0. Test by
//  applying a voltage to channel A14, then setting and running to a break point
...
void main(void)
{
  ...
  P4SEL |= 0x80;                            // Enable A/D channel A0
  ADC12CTL0 = ADC12ON+SHT0_2;               // Turn on ADC12, set sampling time
  ADC12CTL1 = SHP;                          // Use sampling timer
  ADC12MCTL0 = INCH_14;                     // Input channel A14
