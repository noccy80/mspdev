//******************************************************************************
//   MSP430xG461x Demo - DMA2, Rpt'd Blk to DAC1, 8-Bit Sine, TBCCR2, DCO
//
...
void main(void)
{
  ...
  DMA2SA = (void (*)())Sin_tab;                    // Source block address
  DMA2DA = (void (*)())&DAC12_1DAT;                     // Destination single address
