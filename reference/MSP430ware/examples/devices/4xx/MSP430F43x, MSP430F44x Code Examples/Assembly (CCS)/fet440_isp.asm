;*****************************************************************************
;   MSP-FET430P440 Demo - Flash In-System Program Memory
;
...
;   watch crystal is used,the FLL is active and MCLK = 1048576. A breakpoint
;   can be set on "jmp Mainloop", observing flash memory locations
;   01080h/01081h in a memory window.
