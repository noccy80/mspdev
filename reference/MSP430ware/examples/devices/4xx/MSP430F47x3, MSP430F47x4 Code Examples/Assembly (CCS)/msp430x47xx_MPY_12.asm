...
SetupFLL    bis.b   #XCAP14PF,&FLL_CTL0     ; Configure load caps
            ...
            mov.w   #0123h,&MPY32H         ; Load upper 16 bits of operand 1
...
;----------second multiply operation-------------------------------------------
            mov.w   #01234h,&MAC32L         ; Load lower 16 bits of operand 1
            mov.w   #01234h,&MAC32H         ; Load upper 16 bits of operand 1
            mov.w   #05678h,&OP2L           ; Load lower 16 bits of operand 2
            mov.w   #05678h,&OP2H 
            bis.w   #LPM4,SR                ; LPM4
