;******************************************************************************
;   MSP430x42x0 Demo - Timer_A, UART 115200 Echo, DCO SMCLK
;
...
;   ACLK = LFXT1 = 32768Hz, MCLK = SMCLK = ~8MHz
...
Bitime_5    .equ    036                      ; ~ 0.5 bit length
...
;------------------------------------------------------------------------------
            mov.w   #07+01,BitCnt              ; Load Bit Counter, 8 data bits
