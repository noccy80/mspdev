...
TA2_ISR     add.w   &DTMF_hi,&CCR2           ;
            reti                            ;
                                            ;
;EVEN                            ;
DTMF_TABlo  .word      	((MCLK/697)+1)/2        ; Generates 697 Hz
            .word		((MCLK/770)+1)/2        ; Generates 770 Hz
            .word      	((MCLK/852)+1)/2        ; Generates 852 Hz
            .word      	((MCLK/941)+1)/2        ; Generates 941 Hz
DTMF_TABhi  .word      	((MCLK/1209)+1)/2       ; Generates 1209 Hz
            .word      	((MCLK/1336)+1)/2       ; Generates 1336 Hz
            .word      	((MCLK/1477)+1)/2       ; Generates 1477 Hz
            .word      	((MCLK/1633)+1)/2       ; Generates 1633 Hz
                                            ;
;-----------------------------------------------------------------------------
;           Interrupt Vectors
;-----------------------------------------------------------------------------
