;******************************************************************************
;   MSP430x42x0 Demo - Timer_A, UART 2400 Ultra-low Power Echo, 32kHz ACLK
;
...
SetupTA     mov.w   #TASSEL_1+MC_2,&TACTL     ; ACLK, continous mode
...
Mainloop    call    #RX_Ready               ; UART ready to RX one Byte
            bis.w   #LPM3+GIE,SR                ; Enter LPM3 Until Byte RXed
