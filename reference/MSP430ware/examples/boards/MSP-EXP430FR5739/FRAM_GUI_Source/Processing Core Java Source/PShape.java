...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fprocessing%2Fsource%2Fbrowse%2Ftrunk%2Fprocessing%2Fcore%2Fsrc%2Fprocessing%2Fcore%2FPShape.java" 
...
<table id="nav_and_rev" class="list"
 ...
 <a href="/p/processing/source/browse/trunk/processing/core/src/processing/core/PShape.java?edit=1"
 ...
 <li><a href="/p/processing/source/browse/trunk/processing/core/src/processing/core/PShape.java?r=7006" title="Previous">&lsaquo;r7006</a></li>
...
><td class="source">import processing.core.PApplet;<br></td></tr
><tr
id=sl_svn7768_28
...
><td class="source"> * Datatype for storing shapes. Processing can currently load and display SVG (Scalable Vector Graphics) shapes.<br></td></tr
><tr
id=sl_svn7768_32

><td class="source"> * Before a shape is used, it must be loaded with the &lt;b&gt;loadShape()&lt;/b&gt; function. The &lt;b&gt;shape()&lt;/b&gt; function is used to draw the shape to the display window.<br></td></tr
><tr
id=sl_svn7768_33

><td class="source"> * The &lt;b&gt;PShape&lt;/b&gt; object contain a group of methods, linked below, that can operate on the shape data. <br></td></tr
><tr
id=sl_svn7768_34

><td class="source"> * &lt;br&gt;&lt;br&gt;The &lt;b&gt;loadShape()&lt;/b&gt; method supports SVG files created with Inkscape and Adobe Illustrator.<br></td></tr
><tr
id=sl_svn7768_35

><td class="source"> * It is not a full SVG implementation, but offers some straightforward support for handling vector data.<br></td></tr
><tr
id=sl_svn7768_36
...
><td class="source"> * In-progress class to handle shape data, currently to be considered of<br></td></tr
><tr
id=sl_svn7768_39

><td class="source"> * alpha or beta quality. Major structural work may be performed on this class<br></td></tr
><tr
id=sl_svn7768_40

><td class="source"> * after the release of Processing 1.0. Such changes may include:<br></td></tr
><tr
id=sl_svn7768_41
...
><td class="source"> * &lt;li&gt; addition of proper accessors to read shape vertex and coloring data<br></td></tr
><tr
id=sl_svn7768_44

><td class="source"> * (this is the second most important part of having a PShape class after all).<br></td></tr
><tr
id=sl_svn7768_45

><td class="source"> * &lt;li&gt; a means of creating PShape objects ala beginShape() and endShape().<br></td></tr
><tr
id=sl_svn7768_46

><td class="source"> * &lt;li&gt; load(), update(), and cache methods ala PImage, so that shapes can<br></td></tr
><tr
id=sl_svn7768_47

><td class="source"> * have renderer-specific optimizations, such as vertex arrays in OpenGL.<br></td></tr
><tr
id=sl_svn7768_48

><td class="source"> * &lt;li&gt; splitting this class into multiple classes to handle different<br></td></tr
><tr
id=sl_svn7768_49

><td class="source"> * varieties of shape data (primitives vs collections of vertices vs paths)<br></td></tr
><tr
id=sl_svn7768_50

><td class="source"> * &lt;li&gt; change of package declaration, for instance moving the code into<br></td></tr
><tr
id=sl_svn7768_51

><td class="source"> * package processing.shape (if the code grows too much).<br></td></tr
><tr
id=sl_svn7768_52
...
><td class="source"> * &lt;p&gt;For the time being, this class and its shape() and loadShape() friends in<br></td></tr
><tr
id=sl_svn7768_55

><td class="source"> * PApplet exist as placeholders for more exciting things to come. If you&#39;d<br></td></tr
><tr
id=sl_svn7768_56

><td class="source"> * like to work with this class, make a subclass (see how PShapeSVG works)<br></td></tr
><tr
id=sl_svn7768_57

><td class="source"> * and you can play with its internal methods all you like.&lt;/p&gt;<br></td></tr
><tr
id=sl_svn7768_58
...
><td class="source"> * &lt;p&gt;Library developers are encouraged to create PShape objects when loading<br></td></tr
><tr
id=sl_svn7768_60

><td class="source"> * shape data, so that they can eventually hook into the bounty that will be<br></td></tr
><tr
id=sl_svn7768_61

><td class="source"> * the PShape interface, and the ease of loadShape() and shape().&lt;/p&gt;<br></td></tr
><tr
id=sl_svn7768_62
...
><td class="source"> * @webref Shape<br></td></tr
><tr
id=sl_svn7768_64
...
><td class="source"> * @see PApplet#loadShape(String)<br></td></tr
><tr
id=sl_svn7768_67
...
><td class="source"> * @instanceName sh any variable of type PShape<br></td></tr
><tr
id=sl_svn7768_69
...
><td class="source">public class PShape implements PConstants {<br></td></tr
><tr
id=sl_svn7768_71
...
><td class="source">  protected HashMap&lt;String,PShape&gt; nameTable;<br></td></tr
><tr
id=sl_svn7768_74
...
><td class="source">  /** Generic, only draws its child objects. */<br></td></tr
><tr
id=sl_svn7768_76

><td class="source">  static public final int GROUP = 0;<br></td></tr
><tr
id=sl_svn7768_77

><td class="source">  /** A line, ellipse, arc, image, etc. */<br></td></tr
><tr
id=sl_svn7768_78

><td class="source">  static public final int PRIMITIVE = 1;<br></td></tr
><tr
id=sl_svn7768_79

><td class="source">  /** A series of vertex, curveVertex, and bezierVertex calls. */<br></td></tr
><tr
id=sl_svn7768_80

><td class="source">  static public final int PATH = 2;<br></td></tr
><tr
id=sl_svn7768_81

><td class="source">  /** Collections of vertices created with beginShape(). */<br></td></tr
><tr
id=sl_svn7768_82

><td class="source">  static public final int GEOMETRY = 3;<br></td></tr
><tr
id=sl_svn7768_83

><td class="source">  /** The shape type, one of GROUP, PRIMITIVE, PATH, or GEOMETRY. */<br></td></tr
><tr
id=sl_svn7768_84

><td class="source">  protected int family;<br></td></tr
><tr
id=sl_svn7768_85
...
><td class="source">  /** ELLIPSE, LINE, QUAD; TRIANGLE_FAN, QUAD_STRIP; etc. */<br></td></tr
><tr
id=sl_svn7768_87

><td class="source">  protected int primitive;<br></td></tr
><tr
id=sl_svn7768_88
...
><td class="source">  protected PMatrix matrix;<br></td></tr
><tr
id=sl_svn7768_90
...
><td class="source">  /** Texture or image data associated with this shape. */<br></td></tr
><tr
id=sl_svn7768_92

><td class="source">  protected PImage image;<br></td></tr
><tr
id=sl_svn7768_93
...
><td class="source">  // boundary box of this shape<br></td></tr
><tr
id=sl_svn7768_95

><td class="source">  //protected float x;<br></td></tr
><tr
id=sl_svn7768_96

><td class="source">  //protected float y;<br></td></tr
><tr
id=sl_svn7768_97

><td class="source">  //protected float width;<br></td></tr
><tr
id=sl_svn7768_98

><td class="source">  //protected float height;<br></td></tr
><tr
id=sl_svn7768_99
...
><td class="source">   * The width of the PShape document.<br></td></tr
><tr
id=sl_svn7768_101
...
><td class="source">   * @brief  	Shape document width<br></td></tr
><tr
id=sl_svn7768_103
...
><td class="source">  public float width;<br></td></tr
><tr
id=sl_svn7768_105
...
><td class="source">   * @brief  	Shape document height<br></td></tr
><tr
id=sl_svn7768_109
...
><td class="source">  public float height;<br></td></tr
><tr
id=sl_svn7768_111

><td class="source">  public float depth;<br></td></tr
><tr
id=sl_svn7768_112
...
><td class="source">  // set to false if the object is hidden in the layers palette<br></td></tr
><tr
id=sl_svn7768_114

><td class="source">  protected boolean visible = true;<br></td></tr
><tr
id=sl_svn7768_115
...
><td class="source">  protected boolean stroke;<br></td></tr
><tr
id=sl_svn7768_117

><td class="source">  protected int strokeColor;<br></td></tr
><tr
id=sl_svn7768_118

><td class="source">  protected float strokeWeight; // default is 1<br></td></tr
><tr
id=sl_svn7768_119

><td class="source">  protected int strokeCap;<br></td></tr
><tr
id=sl_svn7768_120

><td class="source">  protected int strokeJoin;<br></td></tr
><tr
id=sl_svn7768_121
...
><td class="source">  protected boolean fill;<br></td></tr
><tr
id=sl_svn7768_123

><td class="source">  protected int fillColor;<br></td></tr
><tr
id=sl_svn7768_124
...
><td class="source">  /** Temporary toggle for whether styles should be honored. */<br></td></tr
><tr
id=sl_svn7768_126

><td class="source">  protected boolean style = true;<br></td></tr
><tr
id=sl_svn7768_127
...
><td class="source">  /** For primitive shapes in particular, parms like x/y/w/h or x1/y1/x2/y2. */<br></td></tr
><tr
id=sl_svn7768_129

><td class="source">  protected float[] params;<br></td></tr
><tr
id=sl_svn7768_130
...
><td class="source">  protected int vertexCount;<br></td></tr
><tr
id=sl_svn7768_132
...
><td class="source">   * When drawing POLYGON shapes, the second param is an array of length<br></td></tr
><tr
id=sl_svn7768_134

><td class="source">   * VERTEX_FIELD_COUNT. When drawing PATH shapes, the second param has only<br></td></tr
><tr
id=sl_svn7768_135

><td class="source">   * two variables.<br></td></tr
><tr
id=sl_svn7768_136
...
><td class="source">  protected float[][] vertices;<br></td></tr
><tr
id=sl_svn7768_138
...
><td class="source">  static public final int VERTEX = 0;<br></td></tr
><tr
id=sl_svn7768_140

><td class="source">  static public final int BEZIER_VERTEX = 1;<br></td></tr
><tr
id=sl_svn7768_141

><td class="source">  static public final int CURVE_VERTEX = 2;<br></td></tr
><tr
id=sl_svn7768_142

><td class="source">  static public final int BREAK = 3;<br></td></tr
><tr
id=sl_svn7768_143

><td class="source">  /** Array of VERTEX, BEZIER_VERTEX, and CURVE_VERTEX calls. */<br></td></tr
><tr
id=sl_svn7768_144

><td class="source">  protected int vertexCodeCount;<br></td></tr
><tr
id=sl_svn7768_145

><td class="source">  protected int[] vertexCodes;<br></td></tr
><tr
id=sl_svn7768_146

><td class="source">  /** True if this is a closed path. */<br></td></tr
><tr
id=sl_svn7768_147

><td class="source">  protected boolean close;<br></td></tr
><tr
id=sl_svn7768_148
...
><td class="source">  // should this be called vertices (consistent with PGraphics internals)<br></td></tr
><tr
id=sl_svn7768_150

><td class="source">  // or does that hurt flexibility?<br></td></tr
><tr
id=sl_svn7768_151
...
><td class="source">  protected PShape parent;<br></td></tr
><tr
id=sl_svn7768_153

><td class="source">  protected int childCount;<br></td></tr
><tr
id=sl_svn7768_154

><td class="source">  protected PShape[] children;<br></td></tr
><tr
id=sl_svn7768_155
...
><td class="source">  // POINTS, LINES, xLINE_STRIP, xLINE_LOOP<br></td></tr
><tr
id=sl_svn7768_157

><td class="source">  // TRIANGLES, TRIANGLE_STRIP, TRIANGLE_FAN<br></td></tr
><tr
id=sl_svn7768_158

><td class="source">  // QUADS, QUAD_STRIP<br></td></tr
><tr
id=sl_svn7768_159

><td class="source">  // xPOLYGON<br></td></tr
><tr
id=sl_svn7768_160

><td class="source">//  static final int PATH = 1;  // POLYGON, LINE_LOOP, LINE_STRIP<br></td></tr
><tr
id=sl_svn7768_161

><td class="source">//  static final int GROUP = 2;<br></td></tr
><tr
id=sl_svn7768_162
...
><td class="source">  // how to handle rectmode/ellipsemode?<br></td></tr
><tr
id=sl_svn7768_164

><td class="source">  // are they bitshifted into the constant?<br></td></tr
><tr
id=sl_svn7768_165

><td class="source">  // CORNER, CORNERS, CENTER, (CENTER_RADIUS?)<br></td></tr
><tr
id=sl_svn7768_166

><td class="source">//  static final int RECT = 3; // could just be QUAD, but would be x1/y1/x2/y2<br></td></tr
><tr
id=sl_svn7768_167

><td class="source">//  static final int ELLIPSE = 4;<br></td></tr
><tr
id=sl_svn7768_168
...
><td class="source">//  static final int VERTEX = 7;<br></td></tr
><tr
id=sl_svn7768_170

><td class="source">//  static final int CURVE = 5;<br></td></tr
><tr
id=sl_svn7768_171

><td class="source">//  static final int BEZIER = 6;<br></td></tr
><tr
id=sl_svn7768_172
...
><td class="source">  // fill and stroke functions will need a pointer to the parent<br></td></tr
><tr
id=sl_svn7768_175

><td class="source">  // PGraphics object.. may need some kind of createShape() fxn<br></td></tr
><tr
id=sl_svn7768_176

><td class="source">  // or maybe the values are stored until draw() is called?<br></td></tr
><tr
id=sl_svn7768_177
...
><td class="source">  // attaching images is very tricky.. it&#39;s a different type of data<br></td></tr
><tr
id=sl_svn7768_179
...
><td class="source">  // material parameters will be thrown out,<br></td></tr
><tr
id=sl_svn7768_181

><td class="source">  // except those currently supported (kinds of lights)<br></td></tr
><tr
id=sl_svn7768_182
...
><td class="source">  // pivot point for transformations<br></td></tr
><tr
id=sl_svn7768_184

><td class="source">//  public float px;<br></td></tr
><tr
id=sl_svn7768_185

><td class="source">//  public float py;<br></td></tr
><tr
id=sl_svn7768_186
...
><td class="source">  public PShape() {<br></td></tr
><tr
id=sl_svn7768_189

><td class="source">    this.family = GROUP;<br></td></tr
><tr
id=sl_svn7768_190
...
><td class="source">  public PShape(int family) {<br></td></tr
><tr
id=sl_svn7768_194

><td class="source">    this.family = family;<br></td></tr
><tr
id=sl_svn7768_195
...
><td class="source">  public void setName(String name) {<br></td></tr
><tr
id=sl_svn7768_199

><td class="source">    this.name = name;<br></td></tr
><tr
id=sl_svn7768_200
...
><td class="source">   * Returns a boolean value &quot;true&quot; if the image is set to be visible, &quot;false&quot; if not. This is modified with the &lt;b&gt;setVisible()&lt;/b&gt; parameter.<br></td></tr
><tr
id=sl_svn7768_209

><td class="source">   * &lt;br&gt;&lt;br&gt;The visibility of a shape is usually controlled by whatever program created the SVG file.<br></td></tr
><tr
id=sl_svn7768_210

><td class="source">   * For instance, this parameter is controlled by showing or hiding the shape in the layers palette in Adobe Illustrator.<br></td></tr
><tr
id=sl_svn7768_211
...
><td class="source">   * @brief Returns a boolean value &quot;true&quot; if the image is set to be visible, &quot;false&quot; if not<br></td></tr
><tr
id=sl_svn7768_214
...
><td class="source">  public boolean isVisible() {<br></td></tr
><tr
id=sl_svn7768_216

><td class="source">    return visible;<br></td></tr
><tr
id=sl_svn7768_217
...
><td class="source">   * Sets the shape to be visible or invisible. This is determined by the value of the &lt;b&gt;visible&lt;/b&gt; parameter.<br></td></tr
><tr
id=sl_svn7768_221
...
><td class="source">   * @param visible &quot;false&quot; makes the shape invisible and &quot;true&quot; makes it visible<br></td></tr
><tr
id=sl_svn7768_224
...
><td class="source">   * @brief Sets the shape to be visible or invisible<br></td></tr
><tr
id=sl_svn7768_226
...
><td class="source">  public void setVisible(boolean visible) {<br></td></tr
><tr
id=sl_svn7768_228

><td class="source">    this.visible = visible;<br></td></tr
><tr
id=sl_svn7768_229
...
><td class="source">   * Disables the shape&#39;s style data and uses Processing&#39;s current styles. Styles include attributes such as colors, stroke weight, and stroke joints.<br></td></tr
><tr
id=sl_svn7768_234
...
><td class="source">   * Overrides this shape&#39;s style information and uses PGraphics styles and<br></td></tr
><tr
id=sl_svn7768_236

><td class="source">   * colors. Identical to ignoreStyles(true). Also disables styles for all<br></td></tr
><tr
id=sl_svn7768_237

><td class="source">   * child shapes.<br></td></tr
><tr
id=sl_svn7768_238
...
><td class="source">   * @brief  	Disables the shape&#39;s style data and uses Processing styles<br></td></tr
><tr
id=sl_svn7768_240
...
><td class="source">  public void disableStyle() {<br></td></tr
><tr
id=sl_svn7768_242

><td class="source">    style = false;<br></td></tr
><tr
id=sl_svn7768_243
...
><td class="source">    for (int i = 0; i &lt; childCount; i++) {<br></td></tr
><tr
id=sl_svn7768_245

><td class="source">      children[i].disableStyle();<br></td></tr
><tr
id=sl_svn7768_246
...
><td class="source">   * Enables the shape&#39;s style data and ignores Processing&#39;s current styles. Styles include attributes such as colors, stroke weight, and stroke joints.<br></td></tr
><tr
id=sl_svn7768_252
...
><td class="source">   * @brief Enables the shape&#39;s style data and ignores the Processing styles<br></td></tr
><tr
id=sl_svn7768_254
...
><td class="source">  public void enableStyle() {<br></td></tr
><tr
id=sl_svn7768_256

><td class="source">    style = true;<br></td></tr
><tr
id=sl_svn7768_257
...
><td class="source">      children[i].enableStyle();<br></td></tr
><tr
id=sl_svn7768_260
...
><td class="source">//  protected void checkBounds() {<br></td></tr
><tr
id=sl_svn7768_268
...
><td class="source">//      // calculate bounds here (also take kids into account)<br></td></tr
><tr
id=sl_svn7768_270
...
><td class="source">   * Get the width of the drawing area (not necessarily the shape boundary). <br></td></tr
><tr
id=sl_svn7768_278
...
><td class="source">  public float getWidth() {<br></td></tr
><tr
id=sl_svn7768_280

><td class="source">    //checkBounds();<br></td></tr
><tr
id=sl_svn7768_281
...
><td class="source">   * Get the height of the drawing area (not necessarily the shape boundary). <br></td></tr
><tr
id=sl_svn7768_287
...
><td class="source">  public float getHeight() {<br></td></tr
><tr
id=sl_svn7768_289
...
><td class="source">    return height;<br></td></tr
><tr
id=sl_svn7768_291
...
><td class="source">   * Get the depth of the shape area (not necessarily the shape boundary). Only makes sense for 3D PShape subclasses,<br></td></tr
><tr
id=sl_svn7768_295

><td class="source">   * such as PShape3D. <br></td></tr
><tr
id=sl_svn7768_296
...
><td class="source">  public float getDepth() {<br></td></tr
><tr
id=sl_svn7768_298
...
><td class="source">    return depth;<br></td></tr
><tr
id=sl_svn7768_300
...
><td class="source">   * Return true if this shape is 3D. Defaults to false.<br></td></tr
><tr
id=sl_svn7768_304
...
><td class="source">  boolean strokeSaved;<br></td></tr
><tr
id=sl_svn7768_314

><td class="source">  int strokeColorSaved;<br></td></tr
><tr
id=sl_svn7768_315

><td class="source">  float strokeWeightSaved;<br></td></tr
><tr
id=sl_svn7768_316

><td class="source">  int strokeCapSaved;<br></td></tr
><tr
id=sl_svn7768_317

><td class="source">  int strokeJoinSaved;<br></td></tr
><tr
id=sl_svn7768_318
...
><td class="source">  boolean fillSaved;<br></td></tr
><tr
id=sl_svn7768_320

><td class="source">  int fillColorSaved;<br></td></tr
><tr
id=sl_svn7768_321
...
><td class="source">  int rectModeSaved;<br></td></tr
><tr
id=sl_svn7768_323

><td class="source">  int ellipseModeSaved;<br></td></tr
><tr
id=sl_svn7768_324

><td class="source">  int shapeModeSaved;<br></td></tr
><tr
id=sl_svn7768_325
...
><td class="source">  protected void pre(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_329

><td class="source">    if (matrix != null) {<br></td></tr
><tr
id=sl_svn7768_330
...
><td class="source">      g.applyMatrix(matrix);<br></td></tr
><tr
id=sl_svn7768_332
...
><td class="source">    strokeSaved = g.stroke;<br></td></tr
><tr
id=sl_svn7768_336

><td class="source">    strokeColorSaved = g.strokeColor;<br></td></tr
><tr
id=sl_svn7768_337

><td class="source">    strokeWeightSaved = g.strokeWeight;<br></td></tr
><tr
id=sl_svn7768_338

><td class="source">    strokeCapSaved = g.strokeCap;<br></td></tr
><tr
id=sl_svn7768_339

><td class="source">    strokeJoinSaved = g.strokeJoin;<br></td></tr
><tr
id=sl_svn7768_340
...
><td class="source">    fillSaved = g.fill;<br></td></tr
><tr
id=sl_svn7768_342

><td class="source">    fillColorSaved = g.fillColor;<br></td></tr
><tr
id=sl_svn7768_343
...
><td class="source">    rectModeSaved = g.rectMode;<br></td></tr
><tr
id=sl_svn7768_345

><td class="source">    ellipseModeSaved = g.ellipseMode;<br></td></tr
><tr
id=sl_svn7768_346

><td class="source">    shapeModeSaved = g.shapeMode;<br></td></tr
><tr
id=sl_svn7768_347
...
><td class="source">      styles(g);<br></td></tr
><tr
id=sl_svn7768_351
...
><td class="source">    // should not be necessary because using only the int version of color<br></td></tr
><tr
id=sl_svn7768_357

><td class="source">    //parent.colorMode(PConstants.RGB, 255);<br></td></tr
><tr
id=sl_svn7768_358
...
><td class="source">      g.stroke(strokeColor);<br></td></tr
><tr
id=sl_svn7768_361

><td class="source">      g.strokeWeight(strokeWeight);<br></td></tr
><tr
id=sl_svn7768_362

><td class="source">      g.strokeCap(strokeCap);<br></td></tr
><tr
id=sl_svn7768_363

><td class="source">      g.strokeJoin(strokeJoin);<br></td></tr
><tr
id=sl_svn7768_364
...
><td class="source">      //System.out.println(&quot;filling &quot; + PApplet.hex(fillColor));<br></td></tr
><tr
id=sl_svn7768_370

><td class="source">      g.fill(fillColor);<br></td></tr
><tr
id=sl_svn7768_371
...
><td class="source">  public void post(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_378
...
><td class="source">//      children[i].draw(g);<br></td></tr
><tr
id=sl_svn7768_380
...
><td class="source">    // TODO this is not sufficient, since not saving fillR et al.<br></td></tr
><tr
id=sl_svn7768_384

><td class="source">    g.stroke = strokeSaved;<br></td></tr
><tr
id=sl_svn7768_385

><td class="source">    g.strokeColor = strokeColorSaved;<br></td></tr
><tr
id=sl_svn7768_386

><td class="source">    g.strokeWeight = strokeWeightSaved;<br></td></tr
><tr
id=sl_svn7768_387

><td class="source">    g.strokeCap = strokeCapSaved;<br></td></tr
><tr
id=sl_svn7768_388

><td class="source">    g.strokeJoin = strokeJoinSaved;<br></td></tr
><tr
id=sl_svn7768_389
...
><td class="source">    g.fill = fillSaved;<br></td></tr
><tr
id=sl_svn7768_391

><td class="source">    g.fillColor = fillColorSaved;<br></td></tr
><tr
id=sl_svn7768_392
...
><td class="source">    g.ellipseMode = ellipseModeSaved;<br></td></tr
><tr
id=sl_svn7768_394
...
><td class="source">   * Called by the following (the shape() command adds the g)<br></td></tr
><tr
id=sl_svn7768_408

><td class="source">   * PShape s = loadShapes(&quot;blah.svg&quot;);<br></td></tr
><tr
id=sl_svn7768_409

><td class="source">   * shape(s);<br></td></tr
><tr
id=sl_svn7768_410
...
><td class="source">  public void draw(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_412
...
><td class="source">      pre(g);<br></td></tr
><tr
id=sl_svn7768_414

><td class="source">      drawImpl(g);<br></td></tr
><tr
id=sl_svn7768_415

><td class="source">      post(g);<br></td></tr
><tr
id=sl_svn7768_416
...
><td class="source">   * Draws the SVG document.<br></td></tr
><tr
id=sl_svn7768_422
...
><td class="source">    //System.out.println(&quot;drawing &quot; + family);<br></td></tr
><tr
id=sl_svn7768_425

><td class="source">    if (family == GROUP) {<br></td></tr
><tr
id=sl_svn7768_426

><td class="source">      drawGroup(g);<br></td></tr
><tr
id=sl_svn7768_427

><td class="source">    } else if (family == PRIMITIVE) {<br></td></tr
><tr
id=sl_svn7768_428

><td class="source">      drawPrimitive(g);<br></td></tr
><tr
id=sl_svn7768_429

><td class="source">    } else if (family == GEOMETRY) {<br></td></tr
><tr
id=sl_svn7768_430

><td class="source">      drawGeometry(g);<br></td></tr
><tr
id=sl_svn7768_431

><td class="source">    } else if (family == PATH) {<br></td></tr
><tr
id=sl_svn7768_432

><td class="source">      drawPath(g);<br></td></tr
><tr
id=sl_svn7768_433
...
><td class="source">  protected void drawGroup(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_438
...
><td class="source">  protected void drawPrimitive(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_445

><td class="source">    if (primitive == POINT) {<br></td></tr
><tr
id=sl_svn7768_446

><td class="source">      g.point(params[0], params[1]);<br></td></tr
><tr
id=sl_svn7768_447
...
><td class="source">    } else if (primitive == LINE) {<br></td></tr
><tr
id=sl_svn7768_449

><td class="source">      if (params.length == 4) {  // 2D<br></td></tr
><tr
id=sl_svn7768_450

><td class="source">        g.line(params[0], params[1],<br></td></tr
><tr
id=sl_svn7768_451

><td class="source">               params[2], params[3]);<br></td></tr
><tr
id=sl_svn7768_452

><td class="source">      } else {  // 3D<br></td></tr
><tr
id=sl_svn7768_453

><td class="source">        g.line(params[0], params[1], params[2],<br></td></tr
><tr
id=sl_svn7768_454

><td class="source">               params[3], params[4], params[5]);<br></td></tr
><tr
id=sl_svn7768_455
...
><td class="source">    } else if (primitive == TRIANGLE) {<br></td></tr
><tr
id=sl_svn7768_458

><td class="source">      g.triangle(params[0], params[1],<br></td></tr
><tr
id=sl_svn7768_459
...
><td class="source">                 params[4], params[5]);<br></td></tr
><tr
id=sl_svn7768_461
...
><td class="source">    } else if (primitive == QUAD) {<br></td></tr
><tr
id=sl_svn7768_463

><td class="source">      g.quad(params[0], params[1],<br></td></tr
><tr
id=sl_svn7768_464
...
><td class="source">             params[6], params[7]);<br></td></tr
><tr
id=sl_svn7768_467
...
><td class="source">    } else if (primitive == RECT) {<br></td></tr
><tr
id=sl_svn7768_469
...
><td class="source">        g.imageMode(CORNER);<br></td></tr
><tr
id=sl_svn7768_471

><td class="source">        g.image(image, params[0], params[1], params[2], params[3]);<br></td></tr
><tr
id=sl_svn7768_472
...
><td class="source">        g.rectMode(CORNER);<br></td></tr
><tr
id=sl_svn7768_474

><td class="source">        g.rect(params[0], params[1], params[2], params[3]);<br></td></tr
><tr
id=sl_svn7768_475
...
><td class="source">    } else if (primitive == ELLIPSE) {<br></td></tr
><tr
id=sl_svn7768_478

><td class="source">      g.ellipseMode(CORNER);<br></td></tr
><tr
id=sl_svn7768_479

><td class="source">      g.ellipse(params[0], params[1], params[2], params[3]);<br></td></tr
><tr
id=sl_svn7768_480
...
><td class="source">    } else if (primitive == ARC) {<br></td></tr
><tr
id=sl_svn7768_482
...
><td class="source">      g.arc(params[0], params[1], params[2], params[3], params[4], params[5]);<br></td></tr
><tr
id=sl_svn7768_484
...
><td class="source">    } else if (primitive == BOX) {<br></td></tr
><tr
id=sl_svn7768_486
...
><td class="source">        g.box(params[0]);<br></td></tr
><tr
id=sl_svn7768_488
...
><td class="source">        g.box(params[0], params[1], params[2]);<br></td></tr
><tr
id=sl_svn7768_490
...
><td class="source">    } else if (primitive == SPHERE) {<br></td></tr
><tr
id=sl_svn7768_493

><td class="source">      g.sphere(params[0]);<br></td></tr
><tr
id=sl_svn7768_494
...
><td class="source">  protected void drawGeometry(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_499

><td class="source">    g.beginShape(primitive);<br></td></tr
><tr
id=sl_svn7768_500
...
><td class="source">        g.vertex(vertices[i]);<br></td></tr
><tr
id=sl_svn7768_503
...
><td class="source">        float[] vert = vertices[i];<br></td></tr
><tr
id=sl_svn7768_507

><td class="source">        if (vert[PGraphics.Z] == 0) {<br></td></tr
><tr
id=sl_svn7768_508

><td class="source">          g.vertex(vert[X], vert[Y]);<br></td></tr
><tr
id=sl_svn7768_509
...
><td class="source">          g.vertex(vert[X], vert[Y], vert[Z]);<br></td></tr
><tr
id=sl_svn7768_511
...
><td class="source">  protected void drawPath(PGraphics g) {<br></td></tr
><tr
id=sl_svn7768_520
...
><td class="source">    for (int j = 0; j &lt; childCount; j++) {<br></td></tr
><tr
id=sl_svn7768_522

><td class="source">      if (j &gt; 0) g.breakShape();<br></td></tr
><tr
id=sl_svn7768_523

><td class="source">      int count = children[j].vertexCount;<br></td></tr
><tr
id=sl_svn7768_524

><td class="source">      float[][] vert = children[j].vertices;<br></td></tr
><tr
id=sl_svn7768_525

><td class="source">      int[] code = children[j].vertexCodes;<br></td></tr
><tr
id=sl_svn7768_526
...
><td class="source">          if (children[j].fill) {<br></td></tr
><tr
id=sl_svn7768_530

><td class="source">            g.fill(vert[i][R], vert[i][G], vert[i][B]);<br></td></tr
><tr
id=sl_svn7768_531
...
><td class="source">          if (children[j].stroke) {<br></td></tr
><tr
id=sl_svn7768_535

><td class="source">            g.stroke(vert[i][R], vert[i][G], vert[i][B]);<br></td></tr
><tr
id=sl_svn7768_536
...
><td class="source">        g.edge(vert[i][EDGE] == 1);<br></td></tr
><tr
id=sl_svn7768_541
...
><td class="source">        if (code[i] == VERTEX) {<br></td></tr
><tr
id=sl_svn7768_543

><td class="source">          g.vertex(vert[i]);<br></td></tr
><tr
id=sl_svn7768_544
...
><td class="source">        } else if (code[i] == BEZIER_VERTEX) {<br></td></tr
><tr
id=sl_svn7768_546

><td class="source">          float z0 = vert[i+0][Z];<br></td></tr
><tr
id=sl_svn7768_547

><td class="source">          float z1 = vert[i+1][Z];<br></td></tr
><tr
id=sl_svn7768_548

><td class="source">          float z2 = vert[i+2][Z];<br></td></tr
><tr
id=sl_svn7768_549

><td class="source">          if (z0 == 0 &amp;&amp; z1 == 0 &amp;&amp; z2 == 0) {<br></td></tr
><tr
id=sl_svn7768_550

><td class="source">            g.bezierVertex(vert[i+0][X], vert[i+0][Y], z0,<br></td></tr
><tr
id=sl_svn7768_551

><td class="source">                           vert[i+1][X], vert[i+1][Y], z1,<br></td></tr
><tr
id=sl_svn7768_552

><td class="source">                           vert[i+2][X], vert[i+2][Y], z2);<br></td></tr
><tr
id=sl_svn7768_553
...
><td class="source">            g.bezierVertex(vert[i+0][X], vert[i+0][Y],<br></td></tr
><tr
id=sl_svn7768_555

><td class="source">                           vert[i+1][X], vert[i+1][Y],<br></td></tr
><tr
id=sl_svn7768_556

><td class="source">                           vert[i+2][X], vert[i+2][Y]);<br></td></tr
><tr
id=sl_svn7768_557
...
><td class="source">        } else if (code[i] == CURVE_VERTEX) {<br></td></tr
><tr
id=sl_svn7768_559

><td class="source">          float z = vert[i][Z];<br></td></tr
><tr
id=sl_svn7768_560

><td class="source">          if (z == 0) {<br></td></tr
><tr
id=sl_svn7768_561

><td class="source">            g.curveVertex(vert[i][X], vert[i][Y]);<br></td></tr
><tr
id=sl_svn7768_562
...
><td class="source">            g.curveVertex(vert[i][X], vert[i][Y], z);<br></td></tr
><tr
id=sl_svn7768_564
...
><td class="source">    // Paths might be empty (go figure)<br></td></tr
><tr
id=sl_svn7768_575

><td class="source">    // http://dev.processing.org/bugs/show_bug.cgi?id=982<br></td></tr
><tr
id=sl_svn7768_576

><td class="source">    if (vertices == null) return;<br></td></tr
><tr
id=sl_svn7768_577
...
><td class="source">    if (vertexCodeCount == 0) {  // each point is a simple vertex<br></td></tr
><tr
id=sl_svn7768_581

><td class="source">      if (vertices[0].length == 2) {  // drawing 2D vertices<br></td></tr
><tr
id=sl_svn7768_582
...
><td class="source">          g.vertex(vertices[i][X], vertices[i][Y]);<br></td></tr
><tr
id=sl_svn7768_584
...
><td class="source">      } else {  // drawing 3D vertices<br></td></tr
><tr
id=sl_svn7768_586
...
><td class="source">          g.vertex(vertices[i][X], vertices[i][Y], vertices[i][Z]);<br></td></tr
><tr
id=sl_svn7768_588
...
><td class="source">    } else {  // coded set of vertices<br></td></tr
><tr
id=sl_svn7768_592
...
><td class="source">      if (vertices[0].length == 2) {  // drawing a 2D path<br></td></tr
><tr
id=sl_svn7768_595

><td class="source">        for (int j = 0; j &lt; vertexCodeCount; j++) {<br></td></tr
><tr
id=sl_svn7768_596

><td class="source">          switch (vertexCodes[j]) {<br></td></tr
><tr
id=sl_svn7768_597
...
><td class="source">          case VERTEX:<br></td></tr
><tr
id=sl_svn7768_599

><td class="source">            g.vertex(vertices[index][X], vertices[index][Y]);<br></td></tr
><tr
id=sl_svn7768_600
...
><td class="source">          case BEZIER_VERTEX:<br></td></tr
><tr
id=sl_svn7768_604

><td class="source">            g.bezierVertex(vertices[index+0][X], vertices[index+0][Y],<br></td></tr
><tr
id=sl_svn7768_605

><td class="source">                           vertices[index+1][X], vertices[index+1][Y],<br></td></tr
><tr
id=sl_svn7768_606

><td class="source">                           vertices[index+2][X], vertices[index+2][Y]);<br></td></tr
><tr
id=sl_svn7768_607

><td class="source">            index += 3;<br></td></tr
><tr
id=sl_svn7768_608
...
><td class="source">          case CURVE_VERTEX:<br></td></tr
><tr
id=sl_svn7768_611

><td class="source">            g.curveVertex(vertices[index][X], vertices[index][Y]);<br></td></tr
><tr
id=sl_svn7768_612
...
><td class="source">          case BREAK:<br></td></tr
><tr
id=sl_svn7768_615
...
><td class="source">      } else {  // drawing a 3D path<br></td></tr
><tr
id=sl_svn7768_619
...
><td class="source">            g.vertex(vertices[index][X], vertices[index][Y], vertices[index][Z]);<br></td></tr
><tr
id=sl_svn7768_624
...
><td class="source">            g.bezierVertex(vertices[index+0][X], vertices[index+0][Y], vertices[index+0][Z],<br></td></tr
><tr
id=sl_svn7768_629

><td class="source">                           vertices[index+1][X], vertices[index+1][Y], vertices[index+1][Z],<br></td></tr
><tr
id=sl_svn7768_630

><td class="source">                           vertices[index+2][X], vertices[index+2][Y], vertices[index+2][Z]);<br></td></tr
><tr
id=sl_svn7768_631
...
><td class="source">            g.curveVertex(vertices[index][X], vertices[index][Y], vertices[index][Z]);<br></td></tr
><tr
id=sl_svn7768_636
...
><td class="source">    g.endShape(close ? CLOSE : OPEN);<br></td></tr
><tr
id=sl_svn7768_645
...
><td class="source">  public PShape getParent() {<br></td></tr
><tr
id=sl_svn7768_652

><td class="source">    return parent;<br></td></tr
><tr
id=sl_svn7768_653
...
><td class="source">  public int getChildCount() {<br></td></tr
><tr
id=sl_svn7768_656

><td class="source">    return childCount;<br></td></tr
><tr
id=sl_svn7768_657
...
><td class="source">   * @param index the layer position of the shape to get<br></td></tr
><tr
id=sl_svn7768_662
...
><td class="source">  public PShape getChild(int index) {<br></td></tr
><tr
id=sl_svn7768_664

><td class="source">    return children[index];<br></td></tr
><tr
id=sl_svn7768_665
...
><td class="source">   * Extracts a child shape from a parent shape. Specify the name of the shape with the &lt;b&gt;target&lt;/b&gt; parameter.<br></td></tr
><tr
id=sl_svn7768_669

><td class="source">   * The shape is returned as a &lt;b&gt;PShape&lt;/b&gt; object, or &lt;b&gt;null&lt;/b&gt; is returned if there is an error.<br></td></tr
><tr
id=sl_svn7768_670

><td class="source">   * @param target the name of the shape to get<br></td></tr
><tr
id=sl_svn7768_671
...
><td class="source">   * @brief Returns a child element of a shape as a PShape object<br></td></tr
><tr
id=sl_svn7768_673
...
><td class="source">  public PShape getChild(String target) {<br></td></tr
><tr
id=sl_svn7768_675

><td class="source">    if (name != null &amp;&amp; name.equals(target)) {<br></td></tr
><tr
id=sl_svn7768_676
...
><td class="source">    if (nameTable != null) {<br></td></tr
><tr
id=sl_svn7768_679

><td class="source">      PShape found = nameTable.get(target);<br></td></tr
><tr
id=sl_svn7768_680

><td class="source">      if (found != null) return found;<br></td></tr
><tr
id=sl_svn7768_681
...
><td class="source">      PShape found = children[i].getChild(target);<br></td></tr
><tr
id=sl_svn7768_684
...
><td class="source">   * Same as getChild(name), except that it first walks all the way up the<br></td></tr
><tr
id=sl_svn7768_692

><td class="source">   * hierarchy to the eldest grandparent, so that children can be found anywhere.<br></td></tr
><tr
id=sl_svn7768_693
...
><td class="source">  public PShape findChild(String target) {<br></td></tr
><tr
id=sl_svn7768_695
...
><td class="source">      return getChild(target);<br></td></tr
><tr
id=sl_svn7768_697
...
><td class="source">      return parent.findChild(target);<br></td></tr
><tr
id=sl_svn7768_700
...
><td class="source">  // can&#39;t be just &#39;add&#39; because that suggests additive geometry<br></td></tr
><tr
id=sl_svn7768_705

><td class="source">  public void addChild(PShape who) {<br></td></tr
><tr
id=sl_svn7768_706

><td class="source">    if (children == null) {<br></td></tr
><tr
id=sl_svn7768_707

><td class="source">      children = new PShape[1];<br></td></tr
><tr
id=sl_svn7768_708
...
><td class="source">    if (childCount == children.length) {<br></td></tr
><tr
id=sl_svn7768_710

><td class="source">      children = (PShape[]) PApplet.expand(children);<br></td></tr
><tr
id=sl_svn7768_711
...
><td class="source">    children[childCount++] = who;<br></td></tr
><tr
id=sl_svn7768_713

><td class="source">    who.parent = this;<br></td></tr
><tr
id=sl_svn7768_714
...
><td class="source">    if (who.getName() != null) {<br></td></tr
><tr
id=sl_svn7768_716

><td class="source">      addName(who.getName(), who);<br></td></tr
><tr
id=sl_svn7768_717
...
><td class="source">  // adds child who exactly at position idx in the array of children.<br></td></tr
><tr
id=sl_svn7768_722

><td class="source">  public void addChild(PShape who, int idx) {<br></td></tr
><tr
id=sl_svn7768_723

><td class="source">    if (idx &lt; childCount) {<br></td></tr
><tr
id=sl_svn7768_724
...
><td class="source">      // Copy [idx, childCount - 1] to [idx + 1, childCount]<br></td></tr
><tr
id=sl_svn7768_729

><td class="source">      for (int i = childCount - 1; i &gt;= idx; i--) {<br></td></tr
><tr
id=sl_svn7768_730

><td class="source">        children[i + 1] = children[i];<br></td></tr
><tr
id=sl_svn7768_731
...
><td class="source">      childCount++;<br></td></tr
><tr
id=sl_svn7768_733
...
><td class="source">      children[idx] = who;<br></td></tr
><tr
id=sl_svn7768_735
...
><td class="source">   * Remove the child shape with index idx.<br></td></tr
><tr
id=sl_svn7768_747
...
><td class="source">  public void removeChild(int idx) {<br></td></tr
><tr
id=sl_svn7768_749
...
><td class="source">      PShape child = children[idx];<br></td></tr
><tr
id=sl_svn7768_751
...
><td class="source">      // Copy [idx + 1, childCount - 1] to [idx, childCount - 2]<br></td></tr
><tr
id=sl_svn7768_753

><td class="source">      for (int i = idx; i &lt; childCount - 1; i++) {<br></td></tr
><tr
id=sl_svn7768_754

><td class="source">        children[i] = children[i + 1];<br></td></tr
><tr
id=sl_svn7768_755
...
><td class="source">      if (child.getName() != null &amp;&amp; nameTable != null) {<br></td></tr
><tr
id=sl_svn7768_759

><td class="source">        nameTable.remove(child.getName());<br></td></tr
><tr
id=sl_svn7768_760
...
><td class="source">   * Add a shape to the name lookup table.<br></td></tr
><tr
id=sl_svn7768_767
...
><td class="source">  public void addName(String nom, PShape shape) {<br></td></tr
><tr
id=sl_svn7768_769
...
><td class="source">      parent.addName(nom, shape);<br></td></tr
><tr
id=sl_svn7768_771
...
><td class="source">        nameTable = new HashMap&lt;String,PShape&gt;();<br></td></tr
><tr
id=sl_svn7768_774
...
><td class="source">      nameTable.put(nom, shape);<br></td></tr
><tr
id=sl_svn7768_776
...
><td class="source">   * Returns the index of child who.<br></td></tr
><tr
id=sl_svn7768_782
...
><td class="source">  public int getChildIndex(PShape who) {<br></td></tr
><tr
id=sl_svn7768_784
...
><td class="source">      if (children[i] == who) {<br></td></tr
><tr
id=sl_svn7768_786
...
><td class="source">//  public PShape createGroup() {<br></td></tr
><tr
id=sl_svn7768_795

><td class="source">//    PShape group = new PShape();<br></td></tr
><tr
id=sl_svn7768_796

><td class="source">//    group.kind = GROUP;<br></td></tr
><tr
id=sl_svn7768_797

><td class="source">//    addChild(group);<br></td></tr
><tr
id=sl_svn7768_798
...
><td class="source">  public int getFamily() {<br></td></tr
><tr
id=sl_svn7768_807

><td class="source">    return family;<br></td></tr
><tr
id=sl_svn7768_808
...
><td class="source">  public int getPrimitive() {<br></td></tr
><tr
id=sl_svn7768_812

><td class="source">    return primitive;<br></td></tr
><tr
id=sl_svn7768_813
...
><td class="source">  public float[] getParams() {<br></td></tr
><tr
id=sl_svn7768_817

><td class="source">    return getParams(null);<br></td></tr
><tr
id=sl_svn7768_818
...
><td class="source">  public float[] getParams(float[] target) {<br></td></tr
><tr
id=sl_svn7768_822

><td class="source">    if (target == null || target.length != params.length) {<br></td></tr
><tr
id=sl_svn7768_823

><td class="source">      target = new float[params.length];<br></td></tr
><tr
id=sl_svn7768_824
...
><td class="source">    PApplet.arrayCopy(params, target);<br></td></tr
><tr
id=sl_svn7768_826
...
><td class="source">  public float getParam(int index) {<br></td></tr
><tr
id=sl_svn7768_831

><td class="source">    return params[index];<br></td></tr
><tr
id=sl_svn7768_832
...
><td class="source">  public int getVertexCount() {<br></td></tr
><tr
id=sl_svn7768_836

><td class="source">    return vertexCount;<br></td></tr
><tr
id=sl_svn7768_837
...
><td class="source">  public float[] getVertex(int index) {<br></td></tr
><tr
id=sl_svn7768_841

><td class="source">    if (index &lt; 0 || index &gt;= vertexCount) {<br></td></tr
><tr
id=sl_svn7768_842

><td class="source">      String msg = &quot;No vertex &quot; + index + &quot; for this shape, &quot; +<br></td></tr
><tr
id=sl_svn7768_843

><td class="source">        &quot;only vertices 0 through &quot; + (vertexCount-1) + &quot;.&quot;;<br></td></tr
><tr
id=sl_svn7768_844

><td class="source">      throw new IllegalArgumentException(msg);<br></td></tr
><tr
id=sl_svn7768_845
...
><td class="source">    return vertices[index];<br></td></tr
><tr
id=sl_svn7768_847
...
><td class="source">  public float getVertexX(int index) {<br></td></tr
><tr
id=sl_svn7768_851

><td class="source">    return vertices[index][X];<br></td></tr
><tr
id=sl_svn7768_852
...
><td class="source">  public float getVertexY(int index) {<br></td></tr
><tr
id=sl_svn7768_856

><td class="source">    return vertices[index][Y];<br></td></tr
><tr
id=sl_svn7768_857
...
><td class="source">  public float getVertexZ(int index) {<br></td></tr
><tr
id=sl_svn7768_861

><td class="source">    return vertices[index][Z];<br></td></tr
><tr
id=sl_svn7768_862
...
><td class="source">  public int[] getVertexCodes() {<br></td></tr
><tr
id=sl_svn7768_866

><td class="source">    if (vertexCodes.length != vertexCodeCount) {<br></td></tr
><tr
id=sl_svn7768_867

><td class="source">      vertexCodes = PApplet.subset(vertexCodes, 0, vertexCodeCount);<br></td></tr
><tr
id=sl_svn7768_868
...
><td class="source">    return vertexCodes;<br></td></tr
><tr
id=sl_svn7768_870
...
><td class="source">  public int getVertexCodeCount() {<br></td></tr
><tr
id=sl_svn7768_874

><td class="source">    return vertexCodeCount;<br></td></tr
><tr
id=sl_svn7768_875
...
><td class="source">   * One of VERTEX, BEZIER_VERTEX, CURVE_VERTEX, or BREAK.<br></td></tr
><tr
id=sl_svn7768_880
...
><td class="source">  public int getVertexCode(int index) {<br></td></tr
><tr
id=sl_svn7768_882

><td class="source">    return vertexCodes[index];<br></td></tr
><tr
id=sl_svn7768_883
...
><td class="source">  // http://www.ecse.rpi.edu/Homepages/wrf/Research/Short_Notes/pnpoly.html<br></td></tr
><tr
id=sl_svn7768_890

><td class="source">  public boolean contains(float x, float y) {<br></td></tr
><tr
id=sl_svn7768_891

><td class="source">    if (family == PATH) {<br></td></tr
><tr
id=sl_svn7768_892

><td class="source">      boolean c = false;<br></td></tr
><tr
id=sl_svn7768_893

><td class="source">      for (int i = 0, j = vertexCount-1; i &lt; vertexCount; j = i++) {<br></td></tr
><tr
id=sl_svn7768_894

><td class="source">        if (((vertices[i][Y] &gt; y) != (vertices[j][Y] &gt; y)) &amp;&amp;<br></td></tr
><tr
id=sl_svn7768_895
...
><td class="source">                (vertices[j][X]-vertices[i][X]) * <br></td></tr
><tr
id=sl_svn7768_897

><td class="source">                (y-vertices[i][Y]) / <br></td></tr
><tr
id=sl_svn7768_898

><td class="source">                (vertices[j][1]-vertices[i][Y]) + <br></td></tr
><tr
id=sl_svn7768_899

><td class="source">                vertices[i][X])) {<br></td></tr
><tr
id=sl_svn7768_900

><td class="source">          c = !c;<br></td></tr
><tr
id=sl_svn7768_901
...
><td class="source">      throw new IllegalArgumentException(&quot;The contains() method is only implemented for paths.&quot;);<br></td></tr
><tr
id=sl_svn7768_906
...
><td class="source">  // translate, rotate, scale, apply (no push/pop)<br></td></tr
><tr
id=sl_svn7768_914

><td class="source">  //   these each call matrix.translate, etc<br></td></tr
><tr
id=sl_svn7768_915

><td class="source">  // if matrix is null when one is called,<br></td></tr
><tr
id=sl_svn7768_916

><td class="source">  //   it is created and set to identity<br></td></tr
><tr
id=sl_svn7768_917
...
><td class="source">    checkMatrix(2);<br></td></tr
><tr
id=sl_svn7768_920

><td class="source">    matrix.translate(tx, ty);<br></td></tr
><tr
id=sl_svn7768_921
...
><td class="source">   * Specifies an amount to displace the shape. The &lt;b&gt;x&lt;/b&gt; parameter specifies left/right translation, the &lt;b&gt;y&lt;/b&gt; parameter specifies up/down translation, and the &lt;b&gt;z&lt;/b&gt; parameter specifies translations toward/away from the screen. Subsequent calls to the method accumulates the effect. For example, calling &lt;b&gt;translate(50, 0)&lt;/b&gt; and then &lt;b&gt;translate(20, 0)&lt;/b&gt; is the same as &lt;b&gt;translate(70, 0)&lt;/b&gt;. This transformation is applied directly to the shape, it&#39;s not refreshed each time &lt;b&gt;draw()&lt;/b&gt; is run. <br></td></tr
><tr
id=sl_svn7768_925

><td class="source">   * &lt;br&gt;&lt;br&gt;Using this method with the &lt;b&gt;z&lt;/b&gt; parameter requires using the P3D or OPENGL parameter in combination with size.<br></td></tr
><tr
id=sl_svn7768_926
...
><td class="source">   * @param tx left/right translation<br></td></tr
><tr
id=sl_svn7768_928

><td class="source">   * @param ty up/down translation<br></td></tr
><tr
id=sl_svn7768_929

><td class="source">   * @param tz forward/back translation<br></td></tr
><tr
id=sl_svn7768_930

><td class="source">   * @brief Displaces the shape<br></td></tr
><tr
id=sl_svn7768_931
...
><td class="source">    checkMatrix(3);<br></td></tr
><tr
id=sl_svn7768_934

><td class="source">    matrix.translate(tx, ty, 0);<br></td></tr
><tr
id=sl_svn7768_935
...
><td class="source">   * Rotates a shape around the x-axis the amount specified by the &lt;b&gt;angle&lt;/b&gt; parameter. Angles should be specified in radians (values from 0 to TWO_PI) or converted to radians with the &lt;b&gt;radians()&lt;/b&gt; method.<br></td></tr
><tr
id=sl_svn7768_939

><td class="source">   * &lt;br&gt;&lt;br&gt;Shapes are always rotated around the upper-left corner of their bounding box. Positive numbers rotate objects in a clockwise direction.<br></td></tr
><tr
id=sl_svn7768_940

><td class="source">   * Subsequent calls to the method accumulates the effect. For example, calling &lt;b&gt;rotateX(HALF_PI)&lt;/b&gt; and then &lt;b&gt;rotateX(HALF_PI)&lt;/b&gt; is the same as &lt;b&gt;rotateX(PI)&lt;/b&gt;.<br></td></tr
><tr
id=sl_svn7768_941

><td class="source">   * This transformation is applied directly to the shape, it&#39;s not refreshed each time &lt;b&gt;draw()&lt;/b&gt; is run.  <br></td></tr
><tr
id=sl_svn7768_942

><td class="source">   * &lt;br&gt;&lt;br&gt;This method requires a 3D renderer. You need to pass P3D or OPENGL as a third parameter into the &lt;b&gt;size()&lt;/b&gt; method as shown in the example above.<br></td></tr
><tr
id=sl_svn7768_943

><td class="source">   * @param angle angle of rotation specified in radians<br></td></tr
><tr
id=sl_svn7768_944
...
><td class="source">   * @brief Rotates the shape around the x-axis<br></td></tr
><tr
id=sl_svn7768_946
...
><td class="source">    rotate(angle, 1, 0, 0);<br></td></tr
><tr
id=sl_svn7768_949
...
><td class="source">   * Rotates a shape around the y-axis the amount specified by the &lt;b&gt;angle&lt;/b&gt; parameter. Angles should be specified in radians (values from 0 to TWO_PI) or converted to radians with the &lt;b&gt;radians()&lt;/b&gt; method.<br></td></tr
><tr
id=sl_svn7768_953
...
><td class="source">   * Subsequent calls to the method accumulates the effect. For example, calling &lt;b&gt;rotateY(HALF_PI)&lt;/b&gt; and then &lt;b&gt;rotateY(HALF_PI)&lt;/b&gt; is the same as &lt;b&gt;rotateY(PI)&lt;/b&gt;.<br></td></tr
><tr
id=sl_svn7768_955
...
><td class="source">   * @brief Rotates the shape around the y-axis<br></td></tr
><tr
id=sl_svn7768_960
...
><td class="source">    rotate(angle, 0, 1, 0);<br></td></tr
><tr
id=sl_svn7768_963
...
><td class="source">   * Rotates a shape around the z-axis the amount specified by the &lt;b&gt;angle&lt;/b&gt; parameter. Angles should be specified in radians (values from 0 to TWO_PI) or converted to radians with the &lt;b&gt;radians()&lt;/b&gt; method.<br></td></tr
><tr
id=sl_svn7768_968
...
><td class="source">   * Subsequent calls to the method accumulates the effect. For example, calling &lt;b&gt;rotateZ(HALF_PI)&lt;/b&gt; and then &lt;b&gt;rotateZ(HALF_PI)&lt;/b&gt; is the same as &lt;b&gt;rotateZ(PI)&lt;/b&gt;.<br></td></tr
><tr
id=sl_svn7768_970
...
><td class="source">   * @brief Rotates the shape around the z-axis<br></td></tr
><tr
id=sl_svn7768_975
...
><td class="source">    rotate(angle, 0, 0, 1);<br></td></tr
><tr
id=sl_svn7768_978
...
><td class="source">   * Rotates a shape the amount specified by the &lt;b&gt;angle&lt;/b&gt; parameter. Angles should be specified in radians (values from 0 to TWO_PI) or converted to radians with the &lt;b&gt;radians()&lt;/b&gt; method.<br></td></tr
><tr
id=sl_svn7768_982
...
><td class="source">   * Transformations apply to everything that happens after and subsequent calls to the method accumulates the effect.<br></td></tr
><tr
id=sl_svn7768_984

><td class="source">   * For example, calling &lt;b&gt;rotate(HALF_PI)&lt;/b&gt; and then &lt;b&gt;rotate(HALF_PI)&lt;/b&gt; is the same as &lt;b&gt;rotate(PI)&lt;/b&gt;.<br></td></tr
><tr
id=sl_svn7768_985
...
><td class="source">   * @brief Rotates the shape<br></td></tr
><tr
id=sl_svn7768_989
...
><td class="source">    checkMatrix(2);  // at least 2...<br></td></tr
><tr
id=sl_svn7768_992

><td class="source">    matrix.rotate(angle);<br></td></tr
><tr
id=sl_svn7768_993
...
><td class="source">    matrix.rotate(angle, v0, v1, v2);<br></td></tr
><tr
id=sl_svn7768_999
...
><td class="source">   * @param s percentage to scale the object<br></td></tr
><tr
id=sl_svn7768_1006
...
><td class="source">    matrix.scale(s);<br></td></tr
><tr
id=sl_svn7768_1010
...
><td class="source">  public void scale(float x, float y) {<br></td></tr
><tr
id=sl_svn7768_1014
...
><td class="source">    matrix.scale(x, y);<br></td></tr
><tr
id=sl_svn7768_1016
...
><td class="source">   * Increases or decreases the size of a shape by expanding and contracting vertices. Shapes always scale from the relative origin of their bounding box.<br></td></tr
><tr
id=sl_svn7768_1021

><td class="source">   * Scale values are specified as decimal percentages. For example, the method call &lt;b&gt;scale(2.0)&lt;/b&gt; increases the dimension of a shape by 200%.<br></td></tr
><tr
id=sl_svn7768_1022

><td class="source">   * Subsequent calls to the method multiply the effect. For example, calling &lt;b&gt;scale(2.0)&lt;/b&gt; and then &lt;b&gt;scale(1.5)&lt;/b&gt; is the same as &lt;b&gt;scale(3.0)&lt;/b&gt;.<br></td></tr
><tr
id=sl_svn7768_1023
...
><td class="source">   * &lt;br&gt;&lt;br&gt;Using this fuction with the &lt;b&gt;z&lt;/b&gt; parameter requires passing P3D or OPENGL into the size() parameter.<br></td></tr
><tr
id=sl_svn7768_1025

><td class="source">   * @param x percentage to scale the object in the x-axis<br></td></tr
><tr
id=sl_svn7768_1026

><td class="source">   * @param y percentage to scale the object in the y-axis<br></td></tr
><tr
id=sl_svn7768_1027

><td class="source">   * @param z percentage to scale the object in the z-axis<br></td></tr
><tr
id=sl_svn7768_1028
...
><td class="source">   * @brief Increases and decreases the size of a shape<br></td></tr
><tr
id=sl_svn7768_1030
...
><td class="source">    matrix.scale(x, y, z);<br></td></tr
><tr
id=sl_svn7768_1034
...
><td class="source">    matrix.reset();<br></td></tr
><tr
id=sl_svn7768_1043
...
><td class="source">      applyMatrix((PMatrix2D) source);<br></td></tr
><tr
id=sl_svn7768_1049
...
><td class="source">      applyMatrix((PMatrix3D) source);<br></td></tr
><tr
id=sl_svn7768_1051
...
><td class="source">    applyMatrix(source.m00, source.m01, 0, source.m02,<br></td></tr
><tr
id=sl_svn7768_1057
...
><td class="source">    matrix.apply(n00, n01, n02, 0,<br></td></tr
><tr
id=sl_svn7768_1067
...
><td class="source">    matrix.apply(n00, n01, n02, n03,<br></td></tr
><tr
id=sl_svn7768_1087
...
><td class="source">   * Make sure that the shape&#39;s matrix is 1) not null, and 2) has a matrix<br></td></tr
><tr
id=sl_svn7768_1098

><td class="source">   * that can handle &lt;em&gt;at least&lt;/em&gt; the specified number of dimensions.<br></td></tr
><tr
id=sl_svn7768_1099
...
><td class="source">  protected void checkMatrix(int dimensions) {<br></td></tr
><tr
id=sl_svn7768_1101
...
><td class="source">      if (dimensions == 2) {<br></td></tr
><tr
id=sl_svn7768_1103

><td class="source">        matrix = new PMatrix2D();<br></td></tr
><tr
id=sl_svn7768_1104
...
><td class="source">        matrix = new PMatrix3D();<br></td></tr
><tr
id=sl_svn7768_1106
...
><td class="source">    } else if (dimensions == 3 &amp;&amp; (matrix instanceof PMatrix2D)) {<br></td></tr
><tr
id=sl_svn7768_1108

><td class="source">      // time for an upgrayedd for a double dose of my pimpin&#39;<br></td></tr
><tr
id=sl_svn7768_1109

><td class="source">      matrix = new PMatrix3D(matrix);<br></td></tr
><tr
id=sl_svn7768_1110
...
><td class="source">   * Center the shape based on its bounding box. Can&#39;t assume<br></td></tr
><tr
id=sl_svn7768_1119

><td class="source">   * that the bounding box is 0, 0, width, height. Common case will be<br></td></tr
><tr
id=sl_svn7768_1120

><td class="source">   * opening a letter size document in Illustrator, and drawing something<br></td></tr
><tr
id=sl_svn7768_1121

><td class="source">   * in the middle, then reading it in as an svg file.<br></td></tr
><tr
id=sl_svn7768_1122

><td class="source">   * This will also need to flip the y axis (scale(1, -1)) in cases<br></td></tr
><tr
id=sl_svn7768_1123

><td class="source">   * like Adobe Illustrator where the coordinates start at the bottom.<br></td></tr
><tr
id=sl_svn7768_1124
...
><td class="source">//  public void center() {<br></td></tr
><tr
id=sl_svn7768_1126
...
><td class="source">   * Set the pivot point for all transformations.<br></td></tr
><tr
id=sl_svn7768_1131
...
><td class="source">//  public void pivot(float x, float y) {<br></td></tr
><tr
id=sl_svn7768_1133

><td class="source">//    px = x;<br></td></tr
><tr
id=sl_svn7768_1134

><td class="source">//    py = y;<br></td></tr
><tr
id=sl_svn7768_1135
...
<script type="text/javascript">
 ...
 by andres.colubri
 on Jan 31, 2011
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=7647&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PShape.java&amp;old_path=/trunk/processing/core/src/processing/core/PShape.java&amp;old=7006">Diff</a>
 </div>
 <pre>Merged-in the changes in the core needed
for the new opengl renderer</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/processing/source/detail?r=7647&spec=svn7768';
 var publish_url = '/p/processing/source/detail?r=7647&spec=svn7768#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PApplet.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PApplet.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PConstants.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PConstants.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PFont.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PFont.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphics.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphics3D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics3D.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PGraphicsJava2D.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphicsJava2D.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PImage.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PImage.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PMetadata.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PMetadata.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PParameters.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PParameters.java?r\x3d7647\x26spec\x3dsvn7768');
 
 
 changed_paths.push('/trunk/processing/core/src/processing/core/PShape.java');
 changed_urls.push('/p/processing/source/browse/trunk/processing/core/src/processing/core/PShape.java?r\x3d7647\x26spec\x3dsvn7768');
 
 var selected_path = '/trunk/processing/core/src/processing/core/PShape.java';
 ...
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PApplet.java?r=7647&amp;spec=svn7768"
 
 >...src/processing/core/PApplet.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PConstants.java?r=7647&amp;spec=svn7768"
 
 >.../processing/core/PConstants.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PFont.java?r=7647&amp;spec=svn7768"
 
 >...e/src/processing/core/PFont.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics.java?r=7647&amp;spec=svn7768"
 
 >...c/processing/core/PGraphics.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphics3D.java?r=7647&amp;spec=svn7768"
 
 >...processing/core/PGraphics3D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PGraphicsJava2D.java?r=7647&amp;spec=svn7768"
 
 >...essing/core/PGraphicsJava2D.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PImage.java?r=7647&amp;spec=svn7768"
 
 >.../src/processing/core/PImage.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PMetadata.java?r=7647&amp;spec=svn7768"
 
 >...c/processing/core/PMetadata.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PParameters.java?r=7647&amp;spec=svn7768"
 
 >...processing/core/PParameters.java</option>
 
 <option value="/p/processing/source/browse/trunk/processing/core/src/processing/core/PShape.java?r=7647&amp;spec=svn7768"
 selected="selected"
 >.../src/processing/core/PShape.java</option>
 ...
 by f...@processing.org
 on Jun 25, 2010
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=7006&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PShape.java&amp;old_path=/trunk/processing/core/src/processing/core/PShape.java&amp;old=7005">Diff</a>
 <br>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/processing/source/detail?spec=svn7768&r=7005">r7005</a>
 by f...@processing.org
 on Jun 25, 2010
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=7005&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PShape.java&amp;old_path=/trunk/processing/core/src/processing/core/PShape.java&amp;old=6690">Diff</a>
 <br>
 <pre class="ifOpened">methods for getting params from
shapes, also rect() with rounded
corners
</pre>
 </div>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/processing/source/detail?spec=svn7768&r=6690">r6690</a>
 by fry
 on Jun 05, 2010
 &nbsp; <a href="/p/processing/source/diff?spec=svn7768&r=6690&amp;format=side&amp;path=/trunk/processing/core/src/processing/core/PShape.java&amp;old_path=/trunk/processing/core/src/processing/core/PShape.java&amp;old=5895">Diff</a>
 <br>
 <pre class="ifOpened">lots of new methods for PShape/SVG,
adding support for querying data
</pre>
 </div>
 
 
 <a href="/p/processing/source/list?path=/trunk/processing/core/src/processing/core/PShape.java&start=7647">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div>Size: 34002 bytes,
 1140 lines</div>
 
 <div><a href="http://processing.googlecode.com/svn/trunk/processing/core/src/processing/core/PShape.java">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn7768': '/trunk/processing/core/src/processing/core/PShape.java'}
