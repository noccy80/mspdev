...
#error msp430f5171.h file for use with ICC430/A430 only
#endif
...
#define  TA0CTL_             (0x03C0u)  /* Timer0_A3 Control */
DEFW(    TA0CTL            , TA0CTL_)
#define  TA0CCTL0_           (0x03C2u)  /* Timer0_A3 Capture/Compare Control 0 */
DEFW(    TA0CCTL0          , TA0CCTL0_)
#define  TA0CCTL1_           (0x03C4u)  /* Timer0_A3 Capture/Compare Control 1 */
DEFW(    TA0CCTL1          , TA0CCTL1_)
#define  TA0CCTL2_           (0x03C6u)  /* Timer0_A3 Capture/Compare Control 2 */
DEFW(    TA0CCTL2          , TA0CCTL2_)
#define  TA0R_               (0x03D0u)  /* Timer0_A3 */
DEFW(    TA0R              , TA0R_)
#define  TA0CCR0_            (0x03D2u)  /* Timer0_A3 Capture/Compare 0 */
DEFW(    TA0CCR0           , TA0CCR0_)
#define  TA0CCR1_            (0x03D4u)  /* Timer0_A3 Capture/Compare 1 */
DEFW(    TA0CCR1           , TA0CCR1_)
#define  TA0CCR2_            (0x03D6u)  /* Timer0_A3 Capture/Compare 2 */
DEFW(    TA0CCR2           , TA0CCR2_)
#define  TA0IV_              (0x03EEu)  /* Timer0_A3 Interrupt Vector Word */
DEFW(    TA0IV             , TA0IV_)
#define  TA0EX0_             (0x03E0u)  /* Timer0_A3 Expansion Register 0 */
DEFW(    TA0EX0            , TA0EX0_)
...
#define  TD0CTL0_            (0x0B00u)  /* Timer0_D3 Control 0 */
DEFW(    TD0CTL0           , TD0CTL0_)
#define  TD0CTL1_            (0x0B02u)  /* Timer0_D3 Control 1 */
DEFW(    TD0CTL1           , TD0CTL1_)
#define  TD0CTL2_            (0x0B04u)  /* Timer0_D3 Control 2 */
DEFW(    TD0CTL2           , TD0CTL2_)
#define  TD0R_               (0x0B06u)  /* Timer0_D3 Counter */
DEFW(    TD0R              , TD0R_)
#define  TD0CCTL0_           (0x0B08u)  /* Timer0_D3 Capture/Compare Control 0 */
DEFW(    TD0CCTL0          , TD0CCTL0_)
#define  TD0CCR0_            (0x0B0Au)  /* Timer0_D3 Capture/Compare 0 */
DEFW(    TD0CCR0           , TD0CCR0_)
#define  TD0CL0_             (0x0B0Cu)  /* Timer0_D3 Capture/Compare Latch 0 */
DEFW(    TD0CL0            , TD0CL0_)
#define  TD0CCTL1_           (0x0B0Eu)  /* Timer0_D3 Capture/Compare Control 1 */
DEFW(    TD0CCTL1          , TD0CCTL1_)
#define  TD0CCR1_            (0x0B10u)  /* Timer0_D3 Capture/Compare 1 */
DEFW(    TD0CCR1           , TD0CCR1_)
#define  TD0CL1_             (0x0B12u)  /* Timer0_D3 Capture/Compare Latch 1 */
DEFW(    TD0CL1            , TD0CL1_)
#define  TD0CCTL2_           (0x0B14u)  /* Timer0_D3 Capture/Compare Control 2 */
DEFW(    TD0CCTL2          , TD0CCTL2_)
#define  TD0CCR2_            (0x0B16u)  /* Timer0_D3 Capture/Compare 2 */
DEFW(    TD0CCR2           , TD0CCR2_)
#define  TD0CL2_             (0x0B18u)  /* Timer0_D3 Capture/Compare Latch 2 */
DEFW(    TD0CL2            , TD0CL2_)
#define  TD0HCTL0_           (0x0B38u)  /* Timer0_D3 High-resolution Control Register 0 */
DEFW(    TD0HCTL0          , TD0HCTL0_)
#define  TD0HCTL1_           (0x0B3Au)  /* Timer0_D3 High-resolution Control Register 1 */
DEFW(    TD0HCTL1          , TD0HCTL1_)
#define  TD0HINT_            (0x0B3Cu)  /* Timer0_D3 High-resolution Interrupt Register */
DEFW(    TD0HINT           , TD0HINT_)
#define  TD0IV_              (0x0B3Eu)  /* Timer0_D3 Interrupt Vector Word */
DEFW(    TD0IV             , TD0IV_)

/* TDxCTL0 Control Bits */
#define TDCLGRP1            (0x4000u)  /* Timer0_D3 Compare latch load group 1 */
#define TDCLGRP0            (0x2000u)  /* Timer0_D3 Compare latch load group 0 */
...
#define TDCLR               (0x0004u)  /* Timer0_D3 counter clear */
#define TDIE                (0x0002u)  /* Timer0_D3 interrupt enable */
#define TDIFG               (0x0001u)  /* Timer0_D3 interrupt flag */
...
#define TDCLKM0             (0x0001u)   /* Timer0_D3 Clocking Mode Bit: 0 */
#define TDCLKM1             (0x0002u)   /* Timer0_D3 Clocking Mode Bit: 1 */
#define TD2CMB              (0x0010u)   /* Timer0_D3 TD0CCR Combination in TD2 */
#define TD4CMB              (0x0020u)   /* Timer0_D3 TD0CCR Combination in TD4 */
#define TD6CMB              (0x0040u)   /* Timer0_D3 TD0CCR Combination in TD6 */
#define TDIDEX0             (0x0100u)   /* Timer0_D3 Input divider expansion Bit: 0 */
#define TDIDEX1             (0x0200u)   /* Timer0_D3 Input divider expansion Bit: 1 */
#define TDIDEX2             (0x0400u)   /* Timer0_D3 Input divider expansion Bit: 2 */
...
#define TDCAPM0             (0x0001u)   /* Timer0_D3 Capture Mode of Channel 0 */
#define TDCAPM1             (0x0002u)   /* Timer0_D3 Capture Mode of Channel 1 */
#define TDCAPM2             (0x0004u)   /* Timer0_D3 Capture Mode of Channel 2 */
#define TDCAPM3             (0x0008u)   /* Timer0_D3 Capture Mode of Channel 3 */
#define TDCAPM4             (0x0010u)   /* Timer0_D3 Capture Mode of Channel 4 */
#define TDCAPM5             (0x0020u)   /* Timer0_D3 Capture Mode of Channel 5 */
#define TDCAPM6             (0x0040u)   /* Timer0_D3 Capture Mode of Channel 6 */
...
#define TDHEN               (0x0001u)   /* Timer0_D3 High-Resolution Enable */
#define TDHREGEN            (0x0002u)   /* Timer0_D3 High-Resolution Regulated Mode */
#define TDHEAEN             (0x0004u)   /* Timer0_D3 High-Resolution clock error accum. enable */
#define TDHRON              (0x0008u)   /* Timer0_D3 High-Resolution Generator forced on*/
#define TDHM0               (0x0010u)   /* Timer0_D3 High-Resoltuion Clock Mult. Bit: 0 */
#define TDHM1               (0x0020u)   /* Timer0_D3 High-Resoltuion Clock Mult. Bit: 1 */
#define TDHD0               (0x0040u)   /* Timer0_D3 High-Resolution clock divider Bit: 0 */
#define TDHD1               (0x0080u)   /* Timer0_D3 High-Resolution clock divider Bit: 1 */
#define TDHFW               (0x0100u)   /* Timer0_D7 High-resolution generator fast wakeup enable */
...
#define TDHCLKTRIM0         (0x0002u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 0 */
#define TDHCLKTRIM1         (0x0004u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 1 */
#define TDHCLKTRIM2         (0x0008u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 2 */
#define TDHCLKTRIM3         (0x0010u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 3 */
#define TDHCLKTRIM4         (0x0020u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 4 */
#define TDHCLKTRIM5         (0x0040u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 5 */
#define TDHCLKTRIM6         (0x0080u)   /* Timer0_D3 High-Resolution Clock Trim Bit: 6 */
#define TDHCLKSR0           (0x0100u)   /* Timer0_D3 High-Resolution Clock Sub-Range Bit: 0 */
#define TDHCLKSR1           (0x0200u)   /* Timer0_D3 High-Resolution Clock Sub-Range Bit: 1 */
#define TDHCLKSR2           (0x0400u)   /* Timer0_D3 High-Resolution Clock Sub-Range Bit: 2 */
#define TDHCLKSR3           (0x0800u)   /* Timer0_D3 High-Resolution Clock Sub-Range Bit: 3 */
#define TDHCLKSR4           (0x1000u)   /* Timer0_D3 High-Resolution Clock Sub-Range Bit: 4 */
#define TDHCLKR0            (0x2000u)   /* Timer0_D3 High-Resolution Clock Range Bit: 0 */
#define TDHCLKR1            (0x4000u)   /* Timer0_D3 High-Resolution Clock Range Bit: 1 */
#define TDHCLKCR            (0x8000u)   /* Timer0_D3 High-Resolution Coarse Clock Range */

/* TDxHINT Control Bits */
#define TDHFLIFG            (0x0001u)   /* Timer0_D3 High-Res. fail low Interrupt Flag */
#define TDHFHIFG            (0x0002u)   /* Timer0_D3 High-Res. fail high Interrupt Flag */
#define TDHLKIFG            (0x0004u)   /* Timer0_D3 High-Res. frequency lock Interrupt Flag */
#define TDHUNLKIFG          (0x0008u)   /* Timer0_D3 High-Res. frequency unlock Interrupt Flag */
#define TDHFLIE             (0x0100u)   /* Timer0_D3 High-Res. fail low Interrupt Enable */
#define TDHFHIE             (0x0200u)   /* Timer0_D3 High-Res. fail high Interrupt Enable */
#define TDHLKIE             (0x0400u)   /* Timer0_D3 High-Res. frequency lock Interrupt Enable */
#define TDHUNLKIE           (0x0800u)   /* Timer0_D3 High-Res. frequency unlock Interrupt Enable */
...
#define  TD1CTL0_            (0x0B40u)  /* Timer1_D3 Control 0 */
DEFW(    TD1CTL0           , TD1CTL0_)
#define  TD1CTL1_            (0x0B42u)  /* Timer1_D3 Control 1 */
DEFW(    TD1CTL1           , TD1CTL1_)
#define  TD1CTL2_            (0x0B44u)  /* Timer1_D3 Control 2 */
DEFW(    TD1CTL2           , TD1CTL2_)
#define  TD1R_               (0x0B46u)  /* Timer1_D3 Counter */
DEFW(    TD1R              , TD1R_)
#define  TD1CCTL0_           (0x0B48u)  /* Timer1_D3 Capture/Compare Control 0 */
DEFW(    TD1CCTL0          , TD1CCTL0_)
#define  TD1CCR0_            (0x0B4Au)  /* Timer1_D3 Capture/Compare 0 */
DEFW(    TD1CCR0           , TD1CCR0_)
#define  TD1CL0_             (0x0B4Cu)  /* Timer1_D3 Capture/Compare Latch 0 */
DEFW(    TD1CL0            , TD1CL0_)
#define  TD1CCTL1_           (0x0B4Eu)  /* Timer1_D3 Capture/Compare Control 1 */
DEFW(    TD1CCTL1          , TD1CCTL1_)
#define  TD1CCR1_            (0x0B50u)  /* Timer1_D3 Capture/Compare 1 */
DEFW(    TD1CCR1           , TD1CCR1_)
#define  TD1CL1_             (0x0B52u)  /* Timer1_D3 Capture/Compare Latch 1 */
DEFW(    TD1CL1            , TD1CL1_)
#define  TD1CCTL2_           (0x0B54u)  /* Timer1_D3 Capture/Compare Control 2 */
DEFW(    TD1CCTL2          , TD1CCTL2_)
#define  TD1CCR2_            (0x0B56u)  /* Timer1_D3 Capture/Compare 2 */
DEFW(    TD1CCR2           , TD1CCR2_)
#define  TD1CL2_             (0x0B58u)  /* Timer1_D3 Capture/Compare Latch 2 */
DEFW(    TD1CL2            , TD1CL2_)
#define  TD1HCTL0_           (0x0B78u)  /* Timer1_D3 High-resolution Control Register 0 */
DEFW(    TD1HCTL0          , TD1HCTL0_)
#define  TD1HCTL1_           (0x0B7Au)  /* Timer1_D3 High-resolution Control Register 1 */
DEFW(    TD1HCTL1          , TD1HCTL1_)
#define  TD1HINT_            (0x0B7Cu)  /* Timer1_D3 High-resolution Interrupt Register */
DEFW(    TD1HINT           , TD1HINT_)
#define  TD1IV_              (0x0B7Eu)  /* Timer1_D3 Interrupt Vector Word */
DEFW(    TD1IV             , TD1IV_)
...
#define  TEC0XCTL0_         (0x0C00u)  /* Timer Event Control 0 External Control 0 */
DEFCW(   TEC0XCTL0        , TEC0XCTL0_)
#define  TEC0XCTL1_         (0x0C02u)  /* Timer Event Control 0 External Control 1 */
DEFCW(   TEC0XCTL1        , TEC0XCTL1_)
#define  TEC0XCTL2_         (0x0C04u)  /* Timer Event Control 0 External Control 2 */
DEFCW(   TEC0XCTL2        , TEC0XCTL2_)
#define  TEC0STA_           (0x0C06u)  /* Timer Event Control 0 Status */
DEFCW(   TEC0STA          , TEC0STA_)
#define  TEC0XINT_          (0x0C08u)  /* Timer Event Control 0 External Interrupt */
DEFCW(   TEC0XINT         , TEC0XINT_)
#define  TEC0IV_            (0x0C0Au)  /* Timer Event Control 0 Interrupt Vector */
DEFCW(   TEC0IV           , TEC0IV_)
...
#define  TEC1XCTL0_          (0x0C20u)  /* Timer Event Control 1 External Control 0 */
DEFCW(   TEC1XCTL0         , TEC1XCTL0_)
#define  TEC1XCTL1_          (0x0C22u)  /* Timer Event Control 1 External Control 1 */
DEFCW(   TEC1XCTL1         , TEC1XCTL1_)
#define  TEC1XCTL2_          (0x0C24u)  /* Timer Event Control 1 External Control 2 */
DEFCW(   TEC1XCTL2         , TEC1XCTL2_)
#define  TEC1STA_            (0x0C26u)  /* Timer Event Control 1 Status */
DEFCW(   TEC1STA           , TEC1STA_)
#define  TEC1XINT_           (0x0C28u)  /* Timer Event Control 1 External Interrupt */
DEFCW(   TEC1XINT          , TEC1XINT_)
#define  TEC1IV_             (0x0C2Au)  /* Timer Event Control 1 Interrupt Vector */
DEFCW(   TEC1IV            , TEC1IV_)
