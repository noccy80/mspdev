...
#error msp430fg4270.h file for use with ICC430/A430 only
#endif
...
#define SD16BUFG            (0x8000u)  /* SD16 Channel x Buffer Gain 0:Gain=1 / 1:Gain=2 */
...
#define DAC12GRP            (0x0001u)    /* DAC12 group (not used) */
...
#define SWCTL_              (0x00CFu)  /* OA  Analog Switches Control Register */
DEFC(   SWCTL             , SWCTL_)
