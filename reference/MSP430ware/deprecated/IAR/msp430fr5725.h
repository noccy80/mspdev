...
#error msp430fr5725.h file for use with ICC430/A430 only
#endif
...
#define  TB1CTL_             (0x0400u)  /* Timer1_B3 Control */
DEFW(    TB1CTL            , TB1CTL_)
#define  TB1CCTL0_           (0x0402u)  /* Timer1_B3 Capture/Compare Control 0 */
DEFW(    TB1CCTL0          , TB1CCTL0_)
#define  TB1CCTL1_           (0x0404u)  /* Timer1_B3 Capture/Compare Control 1 */
DEFW(    TB1CCTL1          , TB1CCTL1_)
#define  TB1CCTL2_           (0x0406u)  /* Timer1_B3 Capture/Compare Control 2 */
DEFW(    TB1CCTL2          , TB1CCTL2_)
#define  TB1R_               (0x0410u)  /* Timer1_B3 */
DEFW(    TB1R              , TB1R_)
#define  TB1CCR0_            (0x0412u)  /* Timer1_B3 Capture/Compare 0 */
DEFW(    TB1CCR0           , TB1CCR0_)
#define  TB1CCR1_            (0x0414u)  /* Timer1_B3 Capture/Compare 1 */
DEFW(    TB1CCR1           , TB1CCR1_)
#define  TB1CCR2_            (0x0416u)  /* Timer1_B3 Capture/Compare 2 */
DEFW(    TB1CCR2           , TB1CCR2_)
#define TB1IV_               (0x042Eu)  /* Timer1_B3 Interrupt Vector Word */
READ_ONLY DEFW( TB1IV           , TB1IV_)
#define  TB1EX0_             (0x0420u)  /* Timer1_B3 Expansion Register 0 */
DEFW(    TB1EX0            , TB1EX0_)

/* Bits are already defined within the Timer0_Ax */

/* TB1IV Definitions */
#define TB1IV_NONE          (0x0000u)    /* No Interrupt pending */
#define TB1IV_TB1CCR1       (0x0002u)    /* TB1CCR1_CCIFG */
#define TB1IV_TB1CCR2       (0x0004u)    /* TB1CCR2_CCIFG */
#define TB1IV_3             (0x0006u)    /* Reserved */
#define TB1IV_4             (0x0008u)    /* Reserved */
#define TB1IV_5             (0x000Au)    /* Reserved */
#define TB1IV_6             (0x000Cu)    /* Reserved */
#define TB1IV_TB1IFG        (0x000Eu)    /* TB1IFG */
...
#define  TB2CTL_             (0x0440u)  /* Timer2_B3 Control */
DEFW(    TB2CTL            , TB2CTL_)
#define  TB2CCTL0_           (0x0442u)  /* Timer2_B3 Capture/Compare Control 0 */
DEFW(    TB2CCTL0          , TB2CCTL0_)
#define  TB2CCTL1_           (0x0444u)  /* Timer2_B3 Capture/Compare Control 1 */
DEFW(    TB2CCTL1          , TB2CCTL1_)
#define  TB2CCTL2_           (0x0446u)  /* Timer2_B3 Capture/Compare Control 2 */
DEFW(    TB2CCTL2          , TB2CCTL2_)
#define  TB2R_               (0x0450u)  /* Timer2_B3 */
DEFW(    TB2R              , TB2R_)
#define  TB2CCR0_            (0x0452u)  /* Timer2_B3 Capture/Compare 0 */
DEFW(    TB2CCR0           , TB2CCR0_)
#define  TB2CCR1_            (0x0454u)  /* Timer2_B3 Capture/Compare 1 */
DEFW(    TB2CCR1           , TB2CCR1_)
#define  TB2CCR2_            (0x0456u)  /* Timer2_B3 Capture/Compare 2 */
DEFW(    TB2CCR2           , TB2CCR2_)
#define TB2IV_               (0x046Eu)  /* Timer2_B3 Interrupt Vector Word */
READ_ONLY DEFW( TB2IV           , TB2IV_)
#define  TB2EX0_             (0x0460u)  /* Timer2_B3 Expansion Register 0 */
DEFW(    TB2EX0            , TB2EX0_)
...
#define TIMER2_B1_VECTOR    (42 * 2u) /* 0xFFD4 Timer2_B3 CC1-2, TB */
#define TIMER2_B0_VECTOR    (43 * 2u) /* 0xFFD6 Timer2_B3 CC0 */
#define PORT2_VECTOR        (44 * 2u) /* 0xFFD8 Port 2 */
#define TIMER1_B1_VECTOR    (45 * 2u) /* 0xFFDA Timer1_B3 CC1-2, TB */
#define TIMER1_B0_VECTOR    (46 * 2u) /* 0xFFDC Timer1_B3 CC0 */
