...
#error msp430fg479.h file for use with ICC430/A430 only
#endif
...
#define SWCTL8              (0x0001u)  /* OA  Analog Switch Control 8 */
#define SWCTL9              (0x0002u)  /* OA  Analog Switch Control 9 */
//#define RESERVED            (0x0004u)  /* Reserved */
//#define RESERVED            (0x0008u)  /* Reserved */
#define SWCTL12             (0x0010u)  /* OA  Analog Switch Control 12 */
#define SWCTL13             (0x0020u)  /* OA  Analog Switch Control 13 */
//#define RESERVED            (0x0040u)  /* Reserved */
//#define RESERVED            (0x0080u)  /* Reserved */

#define SWCTL0              (0x0100u)  /* OA  Analog Switch Control 0 */
#define SWCTL1              (0x0200u)  /* OA  Analog Switch Control 1 */
//#define RESERVED            (0x0400u)  /* Reserved */
#define SWCTL3              (0x0800u)  /* OA  Analog Switch Control 3 */
#define SWCTL4              (0x1000u)  /* OA  Analog Switch Control 4 */
#define SWCTL5              (0x2000u)  /* OA  Analog Switch Control 5 */
//#define RESERVED            (0x4000u)  /* Reserved */
#define SWCTL7              (0x8000u)  /* OA  Analog Switch Control 7 */
...
DEFC(   P1SEL             , P1SEL_)
#define P1SEL2_             (0x0057u)  /* Port 1 Selection 2 */
DEFC(   P1SEL2            , P1SEL2_)
...
#define SD16AE_             (0x00B7u)  /* SD16 Analog Input Enable Register */
DEFC(   SD16AE            , SD16AE_)
#define SD16CONF0_          (0x00F7u)  /* SD16 Internal Configuration Register 0 */
...
/* SD16AE */
#define SD16AE0             (0x0001u)  /* SD16 External Input Enable 0 */
#define SD16AE1             (0x0002u)  /* SD16 External Input Enable 1 */
#define SD16AE2             (0x0004u)  /* SD16 External Input Enable 2 */
#define SD16AE3             (0x0008u)  /* SD16 External Input Enable 3 */
#define SD16AE4             (0x0010u)  /* SD16 External Input Enable 4 */
#define SD16AE5             (0x0020u)  /* SD16 External Input Enable 5 */
#define SD16AE6             (0x0040u)  /* SD16 External Input Enable 6 */
#define SD16AE7             (0x0080u)  /* SD16 External Input Enable 7 */
...
#define SD16INCH_0          (0x0000u)  /* SD16 Input Channel select A0 */
#define SD16INCH_1          (0x0001u)  /* SD16 Input Channel select A1 */
#define SD16INCH_2          (0x0002u)  /* SD16 Input Channel select A2 */
#define SD16INCH_3          (0x0003u)  /* SD16 Input Channel select A3 */
#define SD16INCH_4          (0x0004u)  /* SD16 Input Channel select A4 */
...
#define SD16BUF0            (0x2000u)  /* SD16 Channel x High Impedance Input Buffer Select: 0 */
#define SD16BUF1            (0x4000u)  /* SD16 Channel x High Impedance Input Buffer Select: 1 */
...
#define SD16BUF_0           (0x0000u)                /* SD16 High Imp. Input Buffer: Disabled */
