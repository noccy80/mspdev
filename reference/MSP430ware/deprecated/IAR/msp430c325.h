...
#error msp430c325.h file for use with ICC430/A430 only
#endif
...
#define AIN_                (0x0110u)  /* ADC Input */
READ_ONLY DEFW( AIN            , AIN_)
#define AEN_                (0x0112u)  /* ADC Input Enable */
DEFW(   AEN               , AEN_)

#define ACTL_               (0x0114u)  /* ADC Control */
DEFW(   ACTL              , ACTL_)
/* the names of the mode bits are different from the spec */
#define ADSOC               (0x0001u)
#define ADSVCC              (0x0002u)
#define ADIN0               (0x0004u)
#define ADIN1               (0x0008u)
#define ADIN2               (0x0010u)
#define ADINOFF             (0x0020u)
#define ADCSRC0             (0x0040u)
#define ADCSRC1             (0x0080u)
#define ADCSRCOFF           (0x0100u)
#define ADRNG0              (0x0200u)
#define ADRNG1              (0x0400u)
#define ADAUTO              (0x0800u)
#define ADPD                (0x1000u)
/* Channel select coded with Bits 2-5 */
#define ADIN_A0             (0x0000u)                  /* (default) */
...
#define ADAT_               (0x0118u)  /* ADC Data */
READ_ONLY DEFW( ADAT           , ADAT_)
...
#define ADC_VECTOR          (5 * 2u)  /* 0xFFEA ADC */
