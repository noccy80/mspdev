...
#error msp430f4794.h file for use with ICC430/A430 only
#endif
...
#define SD16MEM3_           (0x0118u)  /* SD16 Channel 3 Conversion Memory */
...
#define BASICTIMER_VECTOR   (0 * 2u)  /* 0xFFE0 Basic Timer / RTC */
#define PORT2_VECTOR        (1 * 2u)  /* 0xFFE2 Port 2 */
#define USCIAB1TX_VECTOR    (2 * 2u)  /* 0xFFE4 USCI A1/B1 Transmit */
#define USCIAB1RX_VECTOR    (3 * 2u)  /* 0xFFE6 USCI A1/B1 Receive */
#define PORT1_VECTOR        (4 * 2u)  /* 0xFFE8 Port 1 */
#define TIMERA1_VECTOR      (5 * 2u)  /* 0xFFEA Timer A CC1-2, TA */
#define TIMERA0_VECTOR      (6 * 2u)  /* 0xFFEC Timer A CC0 */
#define SD16A_VECTOR        (7 * 2u)  /* 0xFFEE ADC */
