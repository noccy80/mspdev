...
#define __MSP430_HEADER_VERSION__ 1060
...
#error msp430xgeneric.h file for use with ICC430/A430 only
#endif
...
#define OFS_BAKMEM1           (0x0002u)  /* Battery Backup Memory 0 */
#define OFS_BAKMEM1_L          OFS_BAKMEM1
#define OFS_BAKMEM1_H          OFS_BAKMEM1+1
#define OFS_BAKMEM2           (0x0004u)  /* Battery Backup Memory 0 */
#define OFS_BAKMEM2_L          OFS_BAKMEM2
#define OFS_BAKMEM2_H          OFS_BAKMEM2+1
#define OFS_BAKMEM3           (0x0006u)  /* Battery Backup Memory 0 */
...
#define     DMA0SA_O              (0x0012u)    /* DMA Channel 0 Source Address */
#define     DMA0DA_O              (0x0016u)    /* DMA Channel 0 Destination Address */
...
#define     DMA1SA_O              (0x0022u)    /* DMA Channel 1 Source Address */
#define     DMA1DA_O              (0x0026u)    /* DMA Channel 1 Destination Address */
...
#define     DMA2SA_O              (0x0032u)    /* DMA Channel 2 Source Address */
#define     DMA2DA_O              (0x0036u)    /* DMA Channel 2 Destination Address */
...
#define     DMA3SA_O              (0x0042u)    /* DMA Channel 3 Source Address */
#define     DMA3DA_O              (0x0046u)    /* DMA Channel 3 Destination Address */
...
#define     DMA4SA_O              (0x0052u)    /* DMA Channel 4 Source Address */
#define     DMA4DA_O              (0x0056u)    /* DMA Channel 4 Destination Address */
...
#define     DMA5SA_O              (0x0062u)    /* DMA Channel 5 Source Address */
#define     DMA5DA_O              (0x0066u)    /* DMA Channel 5 Destination Address */
...
#define OFS_PADS              (0x0008u)  /* Port A Resistor Drive Strenght */
...
#define OFS_PBDS              (0x0008u)  /* Port B Resistor Drive Strenght */
...
#define OFS_PCDS              (0x0008u)  /* Port C Resistor Drive Strenght */
...
#define OFS_PDDS              (0x0008u)  /* Port D Resistor Drive Strenght */
...
#define OFS_PEDS              (0x0008u)  /* Port E Resistor Drive Strenght */
...
#define OFS_PFDS              (0x0008u)  /* Port F Resistor Drive Strenght */
...
#define OFS_PJDS              (0x0008u)  /* Port J Resistor Drive Strenght */
...
#define LDOOEN              (0x0800u)  /* PU - LDO Enable (3.3V) */
...
#define LDOOEN_H            (0x0008u)  /* PU - LDO Enable (3.3V) */
...
#define TAxIV_TA1CCR1       (0x0002u)    /* TAxCCR1_CCIFG */
#define TAxIV_TA1CCR2       (0x0004u)    /* TAxCCR2_CCIFG */
#define TAxIV_TA1CCR3       (0x0006u)    /* TAxCCR3_CCIFG */
#define TAxIV_TA1CCR4       (0x0008u)    /* TAxCCR4_CCIFG */
#define TAxIV_TA1CCR5       (0x000Au)    /* TAxCCR5_CCIFG */
#define TAxIV_TA1CCR6       (0x000Cu)    /* TAxCCR6_CCIFG */
...
#define TBxIV_TB1CCR1        (0x0002u)    /* TBxCCR1_CCIFG */
#define TBxIV_TB1CCR2        (0x0004u)    /* TBxCCR2_CCIFG */
#define TBxIV_TB1CCR3        (0x0006u)    /* TBxCCR3_CCIFG */
#define TBxIV_TB1CCR4        (0x0008u)    /* TBxCCR4_CCIFG */
#define TBxIV_TB1CCR5        (0x000Au)    /* TBxCCR5_CCIFG */
#define TBxIV_TB1CCR6        (0x000Cu)    /* TBxCCR6_CCIFG */
...
#define TDIDEX_0            (0*0x0001u) /* Timer_D7 Input divider expansion : /1 */
#define TDIDEX_1            (1*0x0001u) /* Timer_D7 Input divider expansion : /2 */
#define TDIDEX_2            (2*0x0001u) /* Timer_D7 Input divider expansion : /3 */
#define TDIDEX_3            (3*0x0001u) /* Timer_D7 Input divider expansion : /4 */
#define TDIDEX_4            (4*0x0001u) /* Timer_D7 Input divider expansion : /5 */
#define TDIDEX_5            (5*0x0001u) /* Timer_D7 Input divider expansion : /6 */
#define TDIDEX_6            (6*0x0001u) /* Timer_D7 Input divider expansion : /7 */
#define TDIDEX_7            (7*0x0001u) /* Timer_D7 Input divider expansion : /8 */
#define TDIDEX__1           (0*0x0001u) /* Timer_D7 Input divider expansion : /1 */
#define TDIDEX__2           (1*0x0001u) /* Timer_D7 Input divider expansion : /2 */
#define TDIDEX__3           (2*0x0001u) /* Timer_D7 Input divider expansion : /3 */
#define TDIDEX__4           (3*0x0001u) /* Timer_D7 Input divider expansion : /4 */
#define TDIDEX__5           (4*0x0001u) /* Timer_D7 Input divider expansion : /5 */
#define TDIDEX__6           (5*0x0001u) /* Timer_D7 Input divider expansion : /6 */
#define TDIDEX__7           (6*0x0001u) /* Timer_D7 Input divider expansion : /7 */
#define TDIDEX__8           (7*0x0001u) /* Timer_D7 Input divider expansion : /8 */
