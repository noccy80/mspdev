...
#define USB_PID               0x0314        // Product ID (PID)
/*----------------------------------------------------------------------------+
| Firmware Version                                                            |
...
#define DESCRIPTOR_TOTAL_LENGTH            73            // wTotalLength, This is the sum of configuration descriptor length  + CDC descriptor length  + HID descriptor length
...
#define HID1_INTFNUM                1
#define MSC_MAX_LUN_NUMBER                   2           // Maximum number of LUNs supported

#define USB_OUTEP_INT_EN BIT0 | BIT1 | BIT2 
