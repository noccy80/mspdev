...
extern volatile BYTE bDataReceived_event0;// data received event
extern volatile BYTE bDataReceived_event1;
...
BYTE USBHID_handleDataReceived(BYTE intfNum)
{
	if (intfNum == 0)
    {
     	bDataReceived_event0 = TRUE;
    }
    else if(intfNum == 1)
    {
    	bDataReceived_event1 = TRUE; 
    }
    // data received event
