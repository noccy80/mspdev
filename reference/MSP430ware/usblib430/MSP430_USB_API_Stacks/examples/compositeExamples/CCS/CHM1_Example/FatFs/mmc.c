...
#define DLY_US(n)       __delay_cycles(n * (USB_MCLK_FREQ/1000000))  // Delay n microseconds           // KLQ
...
DRESULT disk_ioctl (
	...
	DWORD *buff		/* Buffer to send/receive control data */     // KLQ  Changed from void* to DWORD*
)
{
	DRESULT res;
	BYTE n, csd[16];
