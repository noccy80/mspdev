...
{
    // Disable ints for P1.6 (S1 switch on a FET target board).  We don't want to write to the volume while
    // enumerated on the host, to avoid synchronization problems between the host and the storage volume.    
    P1IE &= ~BIT6;  
