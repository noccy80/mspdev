...
-------------------------------------------------------------------------------+                                         
 ...
 For the demonstartion of this example use the PC HyperTerminal app. In 
 HyperTerminal, use Transfer -> Send Text file... and select the 1K data.txt
 in the USBCDC_Example2 project folder. Once the 1k bytes is received by the
 device, the device sends "Thanks for the data"
...
#include "USB_config/descriptors.h" // Contains Constants that support the descriptor and configuration constants
